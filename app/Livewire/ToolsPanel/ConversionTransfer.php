...
use App\Models\Tools\ConversionTransfers;
  ...
  public function render()
{
    ...
    if (!$user) {
        return view('livewire.tools-panel.conversion-transfer', [
            'customers' => collect(),
...
public function search()
{
    ...
    private function generateConversionPdf($conversionId)
    {
        try {
            ...
            $html = view('pdf.Tools.conversion-transaction', compact('conversion'))->render();
            $mpdf->WriteHTML($html);
