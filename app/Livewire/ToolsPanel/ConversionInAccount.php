...
use App\Models\Tools\ConversionInAccounts;
...
class ConversionInAccount extends Component
{
    ...
    public function render()
    {
        ...
        if (!$user) {
            return view('livewire.tools-panel.conversion-in-account', [
                'customers' => collect(),
   ...
   // ==================== متدهای PDF ====================
    ...
    private function generateConversionPdf($conversionId)
    {
        try {
            ...
            $html = view('pdf.Tools.conversion-in-account', compact('conversion'))->render();
            $mpdf->WriteHTML($html);
