...
use App\Livewire\ToolsPanel\ShopTransaction;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Illuminate\Database\Eloquent\Model;
class ShopConversionTransfer extends Model
{
    
    use HasFactory;

    protected $connection = 'tools';
    protected $table = 'shop_conversion_transfer';
    ...
    {
        return $this->belongsTo(ShopSafe::class, 'form_customer');
    }
    ...
    {
        return $this->hasMany(ShopTransaction::class, 'conversion_transfer_id');
    }

    public function withdrawalTransaction()
    {
        return $this->hasOne(ShopTransaction::class, 'conversion_transfer_id')
                    ->where('type', 'برداشت');
    }
