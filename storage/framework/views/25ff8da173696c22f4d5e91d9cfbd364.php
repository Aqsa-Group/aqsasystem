<div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-6 gap-4 items-stretch mb-4">
                    ...
                    <div>
                        <button wire:click="downloadPDF"
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path d="M15 13L12 16L9 13" stroke="white" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
                    ...
                    <div class="relative">
                        <select wire:model="specificSarafiId"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $sarafis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sarafi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tbody>
                               ...
                               transition-colors" dir="ltr">
                                        <td class="px-2 py-4 text-center">
                                            <span
                                                class="border border-gray-300 px-2 py-1 rounded-lg"><?php echo e($index + 1); ?></span>
                                        </td>
                                        ...
                                        <td
                                            class="px-2 py-4 text-right <?php echo e(($report['balances']['usd'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['usd'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500')); ?>">
                                            <?php echo e(number_format($report['balances']['usd'] ?? 0, 2)); ?>

                                        </td>
                                        <td
                                            class="px-2 py-4 text-right <?php echo e(($report['balances']['afn'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['afn'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500')); ?>">
                                            <?php echo e(number_format($report['balances']['afn'] ?? 0, 2)); ?>

                                        </td>
                                        <td
                                            class="px-2 py-4 text-right <?php echo e(($report['balances']['irr'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['irr'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500')); ?>">
                                            <?php echo e(number_format($report['balances']['irr'] ?? 0, 2)); ?>

                                        </td>
                                        <td
                                            class="px-2 py-4 text-right <?php echo e(($report['balances']['pkr'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['pkr'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500')); ?>">
                                            <?php echo e(number_format($report['balances']['pkr'] ?? 0, 2)); ?>

                                        </td>
                                        <td
                                            class="px-2 py-4 text-right <?php echo e(($report['balances']['eur'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['eur'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500')); ?>">
                                            <?php echo e(number_format($report['balances']['eur'] ?? 0, 2)); ?>

                                        </td>
                                        <td
                                            class="px-2 py-4 text-right <?php echo e(($report['balances']['aed'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['aed'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500')); ?>">
                                            <?php echo e(number_format($report['balances']['aed'] ?? 0, 2)); ?>

                                        </td>
                                        <td
                                            class="px-2 py-4 text-right <?php echo e(($report['balances']['try'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['try'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500')); ?>">
                                            <?php echo e(number_format($report['balances']['try'] ?? 0, 2)); ?>

                                        </td>
                                        <td
                                            class="px-2 py-4 text-right <?php echo e(($report['balances']['cny'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['cny'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500')); ?>">
    ...
    <div x-data="{ showPrintModal: false, printData: null }"
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div x-show="showPrintModal" x-transition:enter="ease-out duration-300"
                                ...
                                <div class="border-2 border-dashed border-gray-300 p-4">
                                    <div class="text-center mb-4">
                                        ...
                                        <p class="text-gray-600"
                                            x-text="'تاریخ چاپ: ' + (printData?.print_date || '')"></p>
                                        <p class="text-gray-600"
                                            x-text="'صرافی جاری: ' + (printData?.current_sarafi || '')"></p>
                                    </div>
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <table class="w-full text-sm border-collapse border border-gray-300">
                                                    ...
                                                    <tbody>
                                                        <template
                                                            x-if="printData?.reports[0]?.transactions?.length > 0">
                                                            <template
                                                                x-for="(transaction, index) in printData?.reports[0]?.transactions"
                                                                :key="index">
                                                                <tr>
                                                                    ...
                                                                    <td class="border border-gray-300 p-2 text-center"
                                                                        :class="transaction.type === 'ارسال' ?
                                                                            'text-red-600' : 'text-green-600'"
                                                                        x-text="transaction.type"></td>
                                                                    <td class="border border-gray-300 p-2 text-center">
                                                                        <span
                                                                            x-text="getCurrencyName(transaction.currency)"></span>
                                                                    </td>
                                                                    ...
                                                                    <td class="border border-gray-300 p-2 text-center"
                                                                        x-text="transaction.account_type || '-'"></td>
                                        ...
                                        <tbody>
                                            <template x-if="printData?.reports?.length > 0">
                                                <template x-for="(report, index) in printData?.reports"
                                                    :key="report.sarafi_id">
                                                    <tr>
                                                        <td class="border border-gray-300 p-2 text-center"
                                                            x-text="index + 1"></td>
                                                        <td class="border border-gray-300 p-2"
                                                            x-text="report.sarafi_name"></td>
                                                        <td class="border border-gray-300 p-2 text-right"
                                                            :class="(report.balances?.usd || 0) < 0 ? 'text-red-600 font-bold' :
                                                                (report.balances?.usd || 0) > 0 ?
                                                                'text-green-600 font-bold' : ''"
                                                            x-text="(report.balances?.usd || 0).toFixed(2)"></td>
                                                        <td class="border border-gray-300 p-2 text-right"
                                                            :class="(report.balances?.afn || 0) < 0 ? 'text-red-600 font-bold' :
                                                                (report.balances?.afn || 0) > 0 ?
                                                                'text-green-600 font-bold' : ''"
                                                            x-text="(report.balances?.afn || 0).toFixed(2)"></td>
                                                        <td class="border border-gray-300 p-2 text-right"
                                                            :class="(report.balances?.irr || 0) < 0 ? 'text-red-600 font-bold' :
                                                                (report.balances?.irr || 0) > 0 ?
                                                                'text-green-600 font-bold' : ''"
                                                            x-text="(report.balances?.irr || 0).toFixed(2)"></td>
                                                        <td class="border border-gray-300 p-2 text-right"
                                                            :class="(report.balances?.pkr || 0) < 0 ? 'text-red-600 font-bold' :
                                                                (report.balances?.pkr || 0) > 0 ?
                                                                'text-green-600 font-bold' : ''"
                                                            x-text="(report.balances?.pkr || 0).toFixed(2)"></td>
                                                        <td class="border border-gray-300 p-2 text-right"
                                                            :class="(report.balances?.eur || 0) < 0 ? 'text-red-600 font-bold' :
                                                                (report.balances?.eur || 0) > 0 ?
                                                                'text-green-600 font-bold' : ''"
                                                            x-text="(report.balances?.eur || 0).toFixed(2)"></td>
                                                        <td class="border border-gray-300 p-2 text-right"
                                                            :class="(report.balances?.aed || 0) < 0 ? 'text-red-600 font-bold' :
                                                                (report.balances?.aed || 0) > 0 ?
                                                                'text-green-600 font-bold' : ''"
                                                            x-text="(report.balances?.aed || 0).toFixed(2)"></td>
                                                        <td class="border border-gray-300 p-2 text-right"
                                                            :class="(report.balances?.try || 0) < 0 ? 'text-red-600 font-bold' :
                                                                (report.balances?.try || 0) > 0 ?
                                                                'text-green-600 font-bold' : ''"
                                                            x-text="(report.balances?.try || 0).toFixed(2)"></td>
                                                        <td class="border border-gray-300 p-2 text-right"
                                                            :class="(report.balances?.cny || 0) < 0 ? 'text-red-600 font-bold' :
                                                                (report.balances?.cny || 0) > 0 ?
                                                                'text-green-600 font-bold' : ''"
                                                            x-text="(report.balances?.cny || 0).toFixed(2)"></td>
                                                        <td class="border border-gray-300 p-2 text-right font-bold"
                                                            :class="report.total_balance < 0 ? 'text-red-600' : (report
                                                                .total_balance > 0 ? 'text-green-600' : '')"
                                    ...
                                    <div class="mt-4 text-sm">
                                        ...
                                        <p class="font-bold">
                                            مجموع کل بیلانس:
                                            <span
                                                :class="printData?.total_balance < 0 ? 'text-red-600' : (printData
                                                    ?.total_balance > 0 ? 'text-green-600' : '')"
...
<?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/livewire/sarafi/sarafi-reports.blade.php ENDPATH**/ ?>