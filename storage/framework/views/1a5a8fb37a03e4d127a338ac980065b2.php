...
<body
    ...
    <div style="font-size: 10.7pt; line-height: 1.8; text-align: justify; margin-bottom: 12pt;  color:black;"
        ...
        در بند دوکان نمبر (<?php echo e($shop->number ?? '_____'); ?>) در طبقه (<?php echo e($shop->floor ?? '_____'); ?>) طرف
        (<?php echo e($shop->side ?? '_____'); ?>) مارکت (<?php echo e($shop->market->name ?? '_____'); ?>)
        واقع همین جایداد متذکره که مساحت آن (<?php echo e($shop->size ?? '_____'); ?>) متر مربع و بدین
        حدود اربعه محدود است شمالاً (<?php echo e($shop->north ?? '____________________'); ?>) شرقاَ
        (<?php echo e($shop->east ?? '____________________'); ?>)
        جنوباً (<?php echo e($shop->south ?? '____________________'); ?>) غرباً (<?php echo e($shop->west ?? '____________________'); ?>)
        بالای محترم (<?php echo e($shopkeeper->fullname ?? '_____'); ?>)
        ولد (<?php echo e($shopkeeper->father_name ?? '_____'); ?>) ولدیت (<?php echo e($shopkeeper->grand_father ?? '_____'); ?>) مسکونه
        (<?php echo e($shopkeeper->address ?? '_____'); ?>) دارنده نمبر تذکره (<?php echo e($shopkeeper->national_id ?? '_____'); ?>)
        در حالی که موصوف نیز دارای اهلیت شرعی و قانونی خویش می‌باشد به مبلغ (<?php echo e(number_format($shop->price ?? 0)); ?>؋)
        افغانی به حرف (<?php echo e($shop->fa_price ?? '___'); ?>) که مناصفه آن (<?php echo e(number_format(($shop->price ?? 0) / 2)); ?>؋) به
        سر قفلی داده‌ام.
    </div>
...
<?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/contracts/sarqofli.blade.php ENDPATH**/ ?>