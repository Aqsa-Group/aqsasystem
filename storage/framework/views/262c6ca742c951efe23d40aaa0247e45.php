...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="w-full">
                                ...
                                <select wire:model="sub_category"
                                    ...
                                    <?php if($category && count($availableSubCategories) > 0): ?>
                                    <?php $__currentLoopData = $availableSubCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
