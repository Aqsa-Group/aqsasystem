...
<head>
    <meta charset="UTF-8">
    <title>تبدیل ارز صرافی - <?php echo e(Auth::guard('tools')->user()->company_name ?? 'صرافی'); ?></title>
    <style>
...
<body>
    <div class="document">
        <h1 style="text-align:center; font-family: amiri ,sans-serif" class="shabnam-fd">صرافی <?php echo e(Auth::guard('tools')->user()->company_name); ?></h1>
        ...
        <div class="contact-info">
            <table style="width:100%; border-collapse: collapse;">
                <tr>
                    <td>
                        <strong>تماس:</strong> +93<?php echo e(Auth::guard('tools')->user()->phone); ?>
                ...
                <tr>
                    <td>
                        <strong>آدرس:</strong> افغانستان <?php echo e(Auth::guard('tools')->user()->address); ?>
...
</html><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/pdf/Tools/cash-exchange.blade.php ENDPATH**/ ?>