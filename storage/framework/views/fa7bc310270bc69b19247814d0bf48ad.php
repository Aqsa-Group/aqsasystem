<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 border">
        ...
        <p class="text-2xl font-bold text-blue-600 mt-2">
            <?php echo e(number_format($safeSummary['total'] ?? 0)); ?>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 border">
        ...
        <p class="text-2xl font-bold text-green-600 mt-2">
            <?php echo e(number_format($safeSummary['today'] ?? 0)); ?>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 border">
        ...
        <p class="text-lg font-semibold mt-2">
            <?php echo e($safeSummary['last_update'] 
...
<?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/filament/import/pages/partials/safe-summary-card.blade.php ENDPATH**/ ?>