    ...
    <div class="flex justify-center items-center h-screen px-4 md:px-0  ">
        <div
            ...
            <div class="md:w-1/2 w-full flex justify-center relative ">
                <img src="<?php echo e(asset('assets/restaurant/login.jpg')); ?>" alt="ورود به پنل صرافی"
            ...
            <div class="md:w-1/2 w-full pr-0 md:pr-6">
                <form action="<?php echo e(route('restaurant.login')); ?>" method="POST"
                    ...
                    <div class="flex flex-col relative">
                        ...
                        <input id="username" name="username" value="<?php echo e(old('username')); ?>" type="text"
...
</html><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/Restaurant/Auth/login.blade.php ENDPATH**/ ?>