        ...
        <table class="min-w-full text-xs md:text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 mb-4 md:mb-5">
            ...
            <tbody>
                ...
                <tr class="border-b dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-3 md:px-6 py-2 md:py-4 vazir text-xs md:text-[16px] font-medium text-black vazir"><?php echo e($staff->job); ?></td>
                    <td class="px-3 md:px-6 py-2 md:py-4 vazir text-xs md:text-[16px] font-medium text-black vazir hidden sm:table-cell"><?php echo e($staff->phone ?? '-'); ?></td>
