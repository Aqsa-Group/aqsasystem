...
<body class="vazir dark:text-white overflow-x-hidden">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentUser && $currentUser->username==='test'): ?>
                    ...
                    <div>
                        <!-- Finance Parent -->
                        <button @click="openItems.finance = !openItems.finance; active = 'finance'" :class="(active === 'finance' || active.startsWith('finance-'))
            ? 'bg-[#122EE1] text-white'
            : 'text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
                            class="flex items-center justify-between w-full py-3 px-4 rounded-lg transition vazir">
                            <span class="flex items-center gap-2">
                            ...
                            <svg class="w-4 h-4 transition-transform" :class="openItems.finance ? 'rotate-180' : ''"
                        ...
                        <div x-show="openItems.finance" x-transition class="mr-6 mt-2 space-y-1">
                            ...
                            <!-- Staff Register -->
                            <a href="<?php echo e(route('sarafi.staff')); ?>" @click="setActive('finance-staff','finance')" :class="active === 'finance-staff'
                ? 'bg-[#122EE1] text-white'
                : 'text-gray-600 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
                            ...
                            <!-- Withdraw -->
                            <a href="<?php echo e(route('sarafi.withdraw')); ?>" @click="setActive('finance-withdraw','finance')"
                ...
                : 'text-gray-600 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
                            ...
                            <a href="<?php echo e(route('sarafi.attendances')); ?>"
                                @click="setActive('finance-attendance','finance')" :class="active === 'finance-attendance'
                ? 'bg-[#122EE1] text-white'
                : 'text-gray-600 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
                                class="nav-link flex items-center gap-2 py-2 px-3 rounded-md text-sm vazir transition">
                            ...
                            <!-- Salary -->
                            <a href="<?php echo e(route('sarafi.salary')); ?>" @click="setActive('finance-salary','finance')"
...
</html><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/Sarafi/layouts/pastsidebar.blade.php ENDPATH**/ ?>