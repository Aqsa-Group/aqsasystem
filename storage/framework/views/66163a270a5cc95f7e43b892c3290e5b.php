    ...
    <div>
        <div>
            <div class="space-y-4 mb-6">
                <h1 class="text-[24px] font-medium vazir">گزارش کلی برداشت‌ها</h1>
            </div>
            ...
            <div class="w-full">
                <div class="bg-[#F5F5F5] dark:bg-black dark:border dark:border-white p-4 rounded-[12px] mx-auto"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-7 gap-4 items-end">
                        ...
                        <!-- کارمند -->
                        <div>
                            <label class="block text-[16px] font-medium mb-1 dark:text-white">کارمند</label>
                            <select wire:model.live="staff"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $staffList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <!-- نوع هزینه -->
                        <div>
                            <label class="block text-[16px] font-medium mb-1 dark:text-white">نوع هزینه</label>
                            <select wire:model.live="expanses_type"
                                class="w-full h-[60px] appearance-none border dark:bg-black dark:border-white
                                   border-[#8C8C8C] rounded-xl px-4 text-sm">
                                <option value="">همه انواع</option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $expansesTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div>
                            <div class="lg:col-span-3 relative" x-data="fromDatePicker()" x-init="init()">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['fromDate'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <div class="lg:col-span-3 relative" x-data="toDatePicker()" x-init="init()">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['toDate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <table class="w-full text-sm md:text-base text-left rtl:text-right text-gray-500">
                                <thead class="bg-[#2B65E5] text-white text-[16px] vazir h-16 sticky top-0">
                                    <tr>
                                        ...
                                        <th class="px-4 py-4 font-bold">کارمند</th>
                                        <th class="px-4 py-4 font-bold">نوع هزینه</th>
                                ...
                                <tbody>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr
                                            ...
                                            <td class="px-4 py-4">
                                                <?php echo e($this->getStaffName($transaction)); ?>

                                            </td>
                                            <td class="px-4 py-4">
                                                <?php echo e($transaction->expanses_type ?? '-'); ?>
                                            ...
                                            <td class="px-4 py-4">
                                                <?php echo e($currencies[$transaction->currency] ?? $transaction->currency); ?>
                                            ...
                                            <td class="px-4 py-4 vazir text-[14px] md:text-[16px] text-center w-40">
                                                <div class="whitespace-nowrap">
                                                    <div class="font-medium">
                                                        <?php echo e(explode(' ', $transaction->date)[0]); ?> </div>
                    ...
                    <table class="w-full text-sm md:text-base text-center text-gray-700 dark:text-white">
                        <thead class="bg-[#2B65E5] text-white text-[16px] vazir h-16">
                            <tr>
                                ...
                                <th class="px-4 py-4">مجموع برداشت</th>
                            </tr>
                        </thead>
...
<?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/livewire/sarafi/withdraw-reports.blade.php ENDPATH**/ ?>