        ...
        <div
            ...
            <div class="w-full md:w-1/2 p-6">
                ...
                <form wire:submit.prevent="withdrawFromSafe">
                    ...
                    <div class="mb-5 grid">
                        <label for="currency" class="mb-2 font-semibold text-gray-700 dark:text-gray-300">
                            نوع ارز
                        </label>
                        <select id="currency" wire:model="withdrawCurrency"
                            class="border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2
                                focus:outline-none focus:ring-2 focus:ring-blue-500
                                dark:bg-gray-800 dark:text-gray-100">
                            <option value="">انتخاب کنید</option>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($withdrawType === 'salary'): ?>
                        <div class="mb-5 grid">
