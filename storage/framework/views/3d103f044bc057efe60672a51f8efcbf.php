<div class="p-6 space-y-6">
    ...
    <!--[if BLOCK]><![endif]--><?php if($alert): ?>
        <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div class="bg-white p-6 rounded shadow w-96 text-center">
                <h3 class="text-lg font-bold mb-4"><?php echo e($alert['title']); ?></h3>
                <p class="mb-4"><?php echo e($alert['message']); ?></p>
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="lg:w-1/2 bg-white shadow-md rounded p-6">
            <h2 class="text-lg font-semibold mb-4"><?php echo e($editId ? 'ویرایش کاربر' : 'افزودن کاربر'); ?></h2>
            ...
            <form wire:submit.prevent="save" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(Auth::check() && Auth::user()->role === 'superadmin'): ?>
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50 border-b">
                            ...
                            <td class="flex gap-2">
                                <button wire:click="edit(<?php echo e($user->id); ?>)" class="text-blue-600 hover:text-blue-800">ویرایش</button>
                                <button wire:click="confirmDelete(<?php echo e($user->id); ?>)" class="text-red-600 hover:text-red-800">حذف</button>
                            </td>
                        </tr>
