            ...
            <template x-if="saleType === 'wholesale'">
                <div class="flex-shrink-0 w-48">
                    ...
                    <select wire:model.defer="customer_id"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \App\Models\Import\Customer::where('user_id', auth()->id())->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <form wire:submit.prevent="submitForm" class="space-y-3 relative">
                        ...
                        <div class="relative">
                            ...
                            <div
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $suggestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
            ...
            <div class="col-span-2 space-y-4">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                ...
                                <td class="p-2 text-gray-600 dark:text-gray-300">
                                    <input type="number" min="0" step="0.001" wire:model.lazy="items.<?php echo e($index); ?>.price"
                ...
                <div
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between" x-show="usdToAfnRate > 0">
                                    ...
                                    <span class="text-xl font-extrabold text-green-600 dark:text-green-400">
                                        <?php echo e(number_format(max((collect($items)->sum('total') - $discount) *
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-xl font-extrabold text-red-600 dark:text-red-400">
                                    <?php echo e(number_format($this->liveRemainingAmount, 3)); ?> دالر
                                </span>
                            </div>
                        </div>
                    </template>
                    ...
                    <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['wire:click' => 'finalizeAndPrintInvoice','class' => 'w-full py-4 rounded-lg font-bold','style' => 'font-size: 20px; background:#2563EB;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'finalizeAndPrintInvoice','class' => 'w-full py-4 rounded-lg font-bold','style' => 'font-size: 20px; background:#2563EB;']); ?>
                        ثبت و چاپ فاکتور
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6330f08526bbb3ce2a0da37da512a11f)): ?>
...
<?php endif; ?><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/filament/pages/sales-panel.blade.php ENDPATH**/ ?>