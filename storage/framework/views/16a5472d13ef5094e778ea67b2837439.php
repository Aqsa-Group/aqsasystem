...
<body
    ...
    <div
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="width: 28mm; height: 28mm; border: 1px solid #1e3a8a; text-align: center; vertical-align: middle;">
                        <img src="<?php echo e(public_path('storage/' . $booth->customer->profile_image)); ?>" alt="امضاء"
        ...
        <div style="font-size: 10.7pt; line-height: 1.8; text-align: justify; margin-bottom: 12pt; color:black;">
            اینجانب <?php echo e($booth->customer?->fullname); ?> ولد <?php echo e($booth->customer->father_name); ?> ولدیت <?php echo e($booth->customer->grand_father); ?>

            دارنده نمبر تذکره (<?php echo e($booth->customer->id_number); ?>)، در حالی که دارای اهلیت کامل شرعی و قانونی خویش می‌باشم،
            غرفه واقع در طبقه (<?php echo e($booth->floor ?? '---'); ?>) نمبر (<?php echo e($booth->number ?? '---'); ?>) را
            برای محترم (<?php echo e($shopkeeper->fullname); ?>) ولد (<?php echo e($shopkeeper->father_name); ?>) ولدیت (<?php echo e($shopkeeper->grand_father); ?>)
            دارنده تذکره (<?php echo e($shopkeeper->national_id); ?>),
...
<?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/contracts/booth_rent_sell.blade.php ENDPATH**/ ?>