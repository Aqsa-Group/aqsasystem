...
<div class="flex flex-col bg-[#F5F5F5] w-full lg:w-[474px] p-[10px] h-auto  rounded-[12px] space-y-2"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($saleType === 'wholesale'): ?>
            <div class="mb-4 sm:mb-6">
                ...
                <div class="relative">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($searchCustomer && count($filteredCustomers) > 0): ?>
                    <div
                        ...
                        <div wire:click="selectCustomer(<?php echo e($customer->id); ?>)"
                            ...
                            <div class="text-xs text-gray-500 mt-1">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customer->idcard_number): ?>
            ...
            <div class="mb-4 sm:mb-6">
                ...
                <div class="relative">
                    ...
                    <!-- دکمه پاک کردن -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($searchProduct): ?>
                ...
                <!-- نمایش لیست محصولات -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($searchProduct && count($filteredProducts) > 0 && !$selectedProduct): ?>
                <div
                ...
                <div
                    ...
                    <div class="flex justify-between items-start mb-3 sm:mb-4">
                        <div>
                            ...
                            <p class="text-xs sm:text-sm text-green-600 mt-1">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedProduct->category): ?>
                                <span class="mr-2 sm:mr-4">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedProduct->is_low_stock): ?>
            ...
            <div class="border-t pt-4 sm:pt-6">
                ...
                <div class="space-y-2 sm:space-y-3 max-h-60 overflow-y-auto mb-4 sm:mb-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                ...
                <div class="bg-gradient-to-r from-gray-50 to-slate-100 p-4 sm:p-6 rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <div class="space-y-2 sm:space-y-3">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex items-center gap-1 sm:gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($saleType === 'retail'): ?>
    ...
    <div class="flex-1 flex flex-col bg-[#F5F5F5] p-3 md:p-4 lg:p-6 rounded-[12px]  mt-[30px] sm:overflow-x-auto md:mt-0 lg:mt-0 mx-auto  md:mx-auto lg:mx-auto w-[440px] mb-5 md:w-[430px] lg:w-[200px] "
            style="box-shadow: 0px 4px 4px 0px #00000040, 0 0 0 0 #3B82F6;">            <div
                ...
                <div class="flex gap-2 items-center w-full md:w-auto">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filterInvoice): ?>
            ...
            <div class="overflow-x-auto rounded-lg border border-gray-200">
                <table class="w-full text-xs sm:text-sm text-left rtl:text-right text-gray-500">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-b border-gray-200 hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="p-2 sm:p-4">
                                <span
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sale->sale_type === 'retail'): ?>
                            ...
                            <td class="p-2 sm:p-4">
                                <div class="flex flex-col">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sale->description): ?>
                                    <span class="text-xs text-gray-500 mt-1">
    ...
    <!-- مودال برگشت کالا -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedSaleForReturn): ?>
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="p-4 sm:p-6">
                ...
                <div class="mb-4 sm:mb-6">
                    ...
                    <div class="space-y-2 sm:space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $returnItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
