    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 p-4">
        ...
        <div
            ...
            <div class="text-center mt-2">
                <div class="text-lg font-bold"><?php echo e(number_format($todaySales)); ?></div>
        ...
        <div
            ...
            <div class="text-center mt-2">
                <div class="text-lg font-bold"><?php echo e(number_format($todayProfit)); ?></div>
                <div class="text-xs mt-1">افغانی</div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="text-center mt-2">
                <div class="text-lg font-bold"><?php echo e(number_format($monthSales)); ?></div>
                <div class="text-xs mt-1">افغانی</div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="text-center mt-2">
                <div class="text-lg font-bold"><?php echo e(number_format($monthProfit)); ?></div>
                <div class="text-xs mt-1">افغانی</div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="text-center mt-2">
                <div class="text-lg font-bold"><?php echo e(number_format($totalSales)); ?></div>
                <div class="text-xs mt-1">افغانی</div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="text-center mt-2">
                <div class="text-lg font-bold"><?php echo e(number_format($totalProfit)); ?></div>
                <div class="text-xs mt-1">افغانی</div>
            </div>
        </div>
    </div>
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <button wire:click="switchToRetail"
                            class="flex-1 px-4 py-3 rounded-lg font-medium transition-all duration-200 <?php echo e($saleType === 'retail' ? 'bg-blue-500 text-white shadow-lg' : 'bg-gray-100 text-gray-700 border border-gray-300'); ?>">
                            <i class="fa-solid fa-user ml-1"></i>
                            پرچون
                        </button>
                        <button wire:click="switchToWholesale"
                            class="flex-1 px-4 py-3 rounded-lg font-medium transition-all duration-200 <?php echo e($saleType === 'wholesale' ? 'bg-purple-500 text-white shadow-lg' : 'bg-gray-100 text-gray-700 border border-gray-300'); ?>">
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        <div wire:click="selectCustomer(<?php echo e($customer->id); ?>)"
                            ...
                            <div class="font-medium text-gray-900"><?php echo e($customer->fullname); ?></div>
                ...
                <div class="space-y-3 max-h-60 overflow-y-auto mb-6">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            <span class="font-bold text-green-600 text-lg"><?php echo e(number_format($item['total'])); ?></span>
                ...
                <div class="bg-gradient-to-r from-gray-50 to-slate-100 p-6 rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-bold text-lg text-gray-900"><?php echo e(number_format($cartTotal)); ?> افغانی</span>
                        </div>
                        ...
                        <div class="flex justify-between items-center bg-blue-50 p-3 rounded-lg">
                            ...
                            <span class="font-bold text-lg text-blue-600"><?php echo e(number_format($cartProfitBeforeDiscount)); ?>
                        ...
                        <div
                            ...
                            <span class="font-bold text-xl text-green-600"><?php echo e(number_format($cartProfit)); ?>
                        ...
                        <div class="border-t pt-3 mt-3">
                            <div class="flex justify-between items-center">
                                ...
                                <span
                                    class="font-bold text-xl <?php echo e($remainingAmount > 0 ? 'text-red-600' : 'text-green-600'); ?>">
                                    <?php if($saleType === 'retail'): ?>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="p-4">
                                <span
                                    class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($sale->sale_type === 'retail' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800'); ?>">
                            ...
                            <td class="p-4">
                                <div class="flex flex-col">
                                    ...
                                    <span class="text-xs text-gray-500 mt-1">
                                        ...
                                        <?php echo e(Str::limit($sale->description, 50)); ?>
                            ...
                            <td class="p-4">
                                ...
                                <div class="flex flex-col">
                                    <span class="font-medium text-gray-700"><?php echo e($sale->customer->fullname); ?></span>
                            ...
                            <td class="p-4 text-center">
                                <span class="font-bold text-gray-900"><?php echo e(number_format($sale->total_price)); ?></span>
                                <div class="text-xs text-gray-500 mt-1">افغانی</div>
                            </td>
                            <td class="p-4 text-center">
                                <span class="font-bold text-green-600"><?php echo e(number_format($sale->received_amount)); ?></span>
                                <div class="text-xs text-gray-500 mt-1">افغانی</div>
                            </td>
                            <td class="p-4 text-center">
                                <span
                                    class="font-bold <?php echo e($sale->remaining_amount > 0 ? 'text-red-600' : 'text-green-600'); ?>">
                            ...
                            <td class="p-4 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    ?>
                                    <span class="font-bold <?php echo e($saleProfit >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                            ...
                            <td class="p-4 text-center">
                                ...
                                <div wire:loading wire:target="printInvoice(<?php echo e($sale->id); ?>)" class="mt-2">
                                    <div
                        ...
                        <div class="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-lg">
                            ...
                            <div class="flex items-center gap-4">
                                <div class="text-center">
                                    ...
                                    <div class="font-bold text-blue-600"><?php echo e($item['quantity']); ?></div>
                                </div>
                ...
                <div class="bg-gradient-to-r from-gray-50 to-slate-100 p-6 rounded-lg border border-gray-200 mb-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-bold text-lg text-red-600"><?php echo e(number_format($returnTotal)); ?> افغانی</span>
                        </div>

                        <div class="flex justify-between items-center">
                            <span class="text-gray-700">مبلغ قابل بازگشت:</span>
                            <span class="font-bold text-lg text-green-600"><?php echo e(number_format($refundAmount)); ?>
