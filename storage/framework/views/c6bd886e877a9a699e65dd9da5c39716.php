    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-4 p-2 sm:p-4">
        ...
        <div
            ...
            <div class="text-center mt-1 sm:mt-2">
                <div class="text-sm sm:text-lg font-bold"><?php echo e(number_format($todaySales)); ?></div>
        ...
        <div
            ...
            <div class="text-center mt-1 sm:mt-2">
                <div class="text-sm sm:text-lg font-bold"><?php echo e(number_format($todayProfit)); ?></div>
                <div class="text-xs mt-1">افغانی</div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="text-center mt-1 sm:mt-2">
                <div class="text-sm sm:text-lg font-bold"><?php echo e(number_format($monthSales)); ?></div>
                <div class="text-xs mt-1">افغانی</div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="text-center mt-1 sm:mt-2">
                <div class="text-sm sm:text-lg font-bold"><?php echo e(number_format($monthProfit)); ?></div>
                <div class="text-xs mt-1">افغانی</div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="text-center mt-1 sm:mt-2">
                <div class="text-sm sm:text-lg font-bold"><?php echo e(number_format($totalSales)); ?></div>
                <div class="text-xs mt-1">افغانی</div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="text-center mt-1 sm:mt-2">
                <div class="text-sm sm:text-lg font-bold"><?php echo e(number_format($totalProfit)); ?></div>
                <div class="text-xs mt-1">افغانی</div>
            </div>
        </div>
    </div>
