...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="flex justify-center gap-4 mt-8 pt-6 pb-5  dark:border-gray-700 w-full">
                ...
                <button type="button" wire:click="resetForm"
                    class="flex items-center justify-center gap-2 w-1/2 py-4 text-lg bg-[#B10909] text-white rounded-xl dark:bg-gray-700 dark:text-gray-200 transition">
                ...
                <!-- ذخیره / بروزرسانی -->
                <button type="submit"
                    class="flex items-center justify-center gap-2 w-1/2 py-4 text-lg bg-gradient-to-br from-indigo-400 to-indigo-500 text-white rounded-xl hover:bg-blue-700 transition">
