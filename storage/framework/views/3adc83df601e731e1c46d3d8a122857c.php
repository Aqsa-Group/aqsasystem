...
<body>
    <div class="container">
        <div class="header">
            <h1>فاکتور فروش</h1>
            <p>شماره: <?php echo e($sale->invoice_number); ?></p>
        </div>
        ...
        <div class="info-section">
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <span class="info-value"><?php echo e(\Morilog\Jalali\Jalalian::fromDateTime($sale->created_at)->format('Y/m/d H:i')); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">نوع فروش</span>
                    <span class="info-value">
                        <span class="type-badge <?php echo e($sale->sale_type === 'retail' ? 'retail' : 'wholesale'); ?>">
...
</html><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/pdf/Tools/sale-invoice.blade.php ENDPATH**/ ?>