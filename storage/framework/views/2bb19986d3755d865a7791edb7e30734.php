                    ...
                    <div class="flex-1">
                        ...
                        <div class="relative w-full">
                            ...
                            <div class="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none text-gray-500">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currency === 'AFN'): ?> افغانی
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <tbody>
                            ...
                            <tr class="text-black border-b border-[#D9D9D9] bg-transparent">
                                ...
                                <td class="px-4 py-4 vazir text-[14px] md:text-[16px] font-medium text-center w-80">
                                    <?php echo e($typesFa[$withdrawal->type] ?? $withdrawal->type); ?>
                                ...
                                <td class="px-4 py-4 vazir text-[14px] md:text-[16px] text-center w-40">
                                    <div class="whitespace-nowrap">
                                        <div class="font-medium">
                                            <?php echo e(\Morilog\Jalali\Jalalian::fromDateTime($withdrawal->created_at)->format('Y/m/d')); ?>
    ...
    <?php $__env->stopPush(); ?>
</div><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/livewire/import/withdrawals.blade.php ENDPATH**/ ?>