    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 p-4">
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p lang='en' dir="ltr" class=" text-left text-sm font-bold mt-1 animate-number" data-target="<?php echo e($todaysale); ?>">0</p>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p lang='en' dir="ltr" class=" text-left text-[25px] font-bold mt-1 animate-number" data-target="<?php echo e($todayprofit); ?>">0</p>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p lang='en' dir="ltr" class=" text-left text-[25px] font-bold mt-1 animate-number vazir" data-target="<?php echo e($withdrawals); ?>">0</p>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p lang='en' dir="ltr" class=" text-left text-[25px] font-bold mt-1 animate-number" data-target="<?php echo e($thismonthsale); ?>">0</p>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p lang='en' dir="ltr" class=" text-left text-[25px] font-bold mt-1 animate-number" data-target="<?php echo e($inventorytotalprice); ?>">0</p>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p lang='en' dir="ltr" class=" text-left text-[25px] font-bold mt-1 animate-number" data-target="<?php echo e($warehousetotalprice); ?>">0</p>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p dir="ltr"  lang="en" class=" text-left text-[25px] font-bold mt-1 animate-number" data-target="<?php echo e($totalstock); ?>">0</p>
            ...
            <div class="flex items-end justify-between">
                <div class="flex flex-col gap-2">
                    <div class="flex justify-center items-center text-2xl vazir ">
                        ...
                        <p lang="en" dir="ltr" class="text-[25px] text-left font-bold mt-1 animate-number vazir" data-target="<?php echo e($totalUsdLoan); ?>">0</p>
                    </div>

                    <div class="flex justify-center items-center text-2xl ">
                        <span> اف: </span>

                        <p  lang="en" dir="ltr" class="text-[25px] text-left font-bold mt-1 animate-number" data-target="<?php echo e($totalAFNLoan); ?>">0</p>
                    </div>
                </div>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p class="text-[25px] font-bold mt-1 animate-number" data-target="<?php echo e($usercount); ?>">0</p>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p class="text-[25px] font-bold mt-1 animate-number" data-target="<?php echo e($countcustomer); ?>">0</p>
...
<script>
    ...
    const profitData = <?php echo json_encode($profitPerMonth, 15, 512) ?>;
    const lossData = <?php echo json_encode($lossPerMonth, 15, 512) ?>;
    ...
    function animateRealDataNumbers() {
        ...
        if (todayProfitEl) {
            animateNumber(todayProfitEl, <?php echo json_encode($todayprofit, 15, 512) ?>, 1500);
        }
        if (todaySaleEl) {
            animateNumber(todaySaleEl, <?php echo json_encode($todaysale, 15, 512) ?>, 1500);
        }
        if (thisMonthSaleEl) {
            animateNumber(thisMonthSaleEl, <?php echo json_encode($thismonthsale, 15, 512) ?>, 1500);
        }
    }
    ...
    Livewire.on('chartUpdated', () => {
        setTimeout(() => {
            profitChart.updateSeries([{
                name: 'فایده',
                data: window.Livewire.find('<?php echo e($_instance->getId()); ?>').profitPerMonth
            }]);
            
            lossChart.updateSeries([{
                name: 'ضرر', 
                data: window.Livewire.find('<?php echo e($_instance->getId()); ?>').lossPerMonth
            }]);
        }, 100);
    });

});
</script><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/livewire/gym/club-accounting/dashboard.blade.php ENDPATH**/ ?>