...
<head>
    <meta charset="UTF-8">
    <title>تراکنش صرافی - <?php echo e($user->company_name ?? 'صرافی'); ?></title>
    <style>
...
<body>
    <div class="document">
        <h1 style="text-align:center; font-family: amiri ,sans-serif" class="shabnam-fd "> صرافی <?php echo e($currentUser->company_name ?? 'صرافی'); ?></h1>
        <div class="header">
   ...
   <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo e($transaction->created_at->format('A') == 'AM' ? 'قبل از ظهر' : 'بعد از ظهر'); ?>
...
</html><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/pdf/Tools/transaction.blade.php ENDPATH**/ ?>