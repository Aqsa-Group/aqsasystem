        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 px-2 sm:px-4 pb-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $currenciesdefault; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="h-[135px] w-full pr-5 pl-5 pt-3 rounded-[12px]
                    ...
                    <h1 class="text-[20px] md:text-[22px] truncate"><?php echo e($currency['name']); ?></h1>
                    <h2 class="text-center text-[26px] md:text-[28px] mt-1 font-bold">
                        <?php echo e(number_format($currency['value'])); ?>
                    ...
                    <div class="mt-2 flex flex-col lg:flex-row gap-3">
                        ...
                        <div class="flex-1">
                            <div class="relative w-full">
                                <label class="block text-[16px] font-medium text-black mb-1 vazir">انتخاب حساب</label>
                                <div x-data="{
                                            searchValue: '',
...
</div><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/livewire/tools-panel/shop-conversion.blade.php ENDPATH**/ ?>