        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow-md p-3 border border-gray-200 dark:border-gray-700">
            <div class="flex items-end gap-3">
                <div class="flex-1">
                    ...
                    <input wire:model.defer="invoiceNumber" wire:keydown.enter="loadSale" type="number"
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sale): ?>
        <div
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm dark:text-gray-300">
                    مبلغ فعلی فاکتور: <span class="font-bold"><?php echo e(number_format($sale->total_price)); ?></span> دالر
                </div>
            </div>
...
<?php endif; ?><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/filament/pages/return-panel.blade.php ENDPATH**/ ?>