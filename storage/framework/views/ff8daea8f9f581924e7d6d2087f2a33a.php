...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                ...
                <button type="submit"
                    class="px-8 py-4 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition">
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $staffs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-b dark:bg-black dark:text-white hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <!-- Salary -->
                            <td class="px-6 py-4">
                                <?php echo e(number_format($staff->salary_amount)); ?> افغانی
                            </td>
...
<?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/livewire/sarafi/staff.blade.php ENDPATH**/ ?>