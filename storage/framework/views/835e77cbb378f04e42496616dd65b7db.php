                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(in_array($reportType, ['inventory', 'warehouse', 'sale_items'])): ?>
                                <div class="space-y-2">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select wire:model.live="packageType"
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $packageTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <!-- Status Filter -->
                                <!--[if BLOCK]><![endif]--><?php if(in_array($reportType, ['inventory', 'warehouse'])): ?>
                                <div class="space-y-2">
                                ...
                                <!-- Sale Type Filter -->
                                <!--[if BLOCK]><![endif]--><?php if($reportType === 'sale'): ?>
                                <div class="space-y-2">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(in_array($reportType, ['withdrawal', 'loan', 'inventory_history',
                                'warehouse_history'])): ?>
                                <div class="space-y-2">
