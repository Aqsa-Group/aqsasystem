...
<body
                        ...
                        <table style="width: 100%; border-collapse: collapse; margin: 0 auto;">
                            <tr>
                                ...
                                <td style="border: 1px solid #1e3a8a; padding: 3px;">
                                    <?php echo e(number_format($shop->sarqofli_price ?? 0)); ?>؋</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #1e3a8a; padding: 3px;">مناصفه</td>
                                <td style="border: 1px solid #1e3a8a; padding: 3px;">
                                    <?php echo e(number_format(($shop->sarqofli_price ?? 0) / 2)); ?>؋</td>
                            </tr>
                        </table>
    ...
    <div style="font-size: 10.7pt; line-height: 1.8; text-align: justify; margin-bottom: 12pt;  color:black;"
        ...
        در حالی که موصوف نیز دارای اهلیت شرعی و قانونی خویش می‌باشد به مبلغ (<?php echo e(number_format($shop->sarqofli_price ?? 0)); ?>؋)
        افغانی به حرف (<?php echo e($shop->sarqofli_fa_price ?? '___'); ?>) که مناصفه آن (<?php echo e(number_format(($shop->sarqofli_price ?? 0) / 2)); ?>؋) به
        سر قفلی داده‌ام.
    </div>
...
<?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/contracts/sarqofli2.blade.php ENDPATH**/ ?>