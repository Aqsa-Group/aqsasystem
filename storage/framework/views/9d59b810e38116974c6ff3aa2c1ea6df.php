...
<?php if($transactions->count() > 0): ?>
    <h3 style="margin-top: 20px; margin-bottom: 10px; font-size: 11pt;">لیست تراکنش‌ها (<?php echo e($transactions->count()); ?> رکورد)</h3>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div style="font-size: 7pt; color: #666;"><?php echo e($transaction->customer->account_number ?? ''); ?></div>
                </td>
                ...
                <td>
                    <div><?php echo e($transaction->date); ?></div>
    ...
    <table class="summary-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-green"><?php echo e(number_format($item->receipt_cash, 2)); ?></td>
                <td class="text-red"><?php echo e(number_format($item->withdrawal_cash, 2)); ?></td>
                <td class="text-green"><?php echo e(number_format($item->receipt_bank, 2)); ?></td>
                <td class="text-red"><?php echo e(number_format($item->withdrawal_bank, 2)); ?></td>
                <td class="<?php echo e($item->balance_cash >= 0 ? 'text-green' : 'text-red'); ?>">
                    <strong><?php echo e(number_format($item->balance_cash, 2)); ?></strong>
                </td>
                <td class="<?php echo e($item->balance_bank >= 0 ? 'text-green' : 'text-red'); ?>">
