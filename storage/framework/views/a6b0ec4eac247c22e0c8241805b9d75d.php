<div>
                ...
                <table class="w-[500px] text-sm md:text-base text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <thead
                        ...
                        <tr cl>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['usd', 'afn', 'irr', 'eur', 'pkr', 'aed', 'try', 'cny']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <tr class="text-black dark:text-white border-b border-[#D9D9D9]
        ...
        <div class="grid grid-cols-3 md:grid-cols-8 justify-center items-center text-center mx-auto pr-14 mt-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [ 'afn', 'usd' , 'irr' ,'pkr', 'eur', 'aed', 'try', 'cny']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
...
>
 ...
 <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        </svg>                        <?php echo e($isEditing ? 'فورم ویرایش معاملات نقدی' : 'فورم ثبت معاملات نقدی'); ?>
                        ...
                        <div class="lg:w-full">
                            ...
                            <div class="relative">
                                <select wire:model="currency"
                                    class="w-full dark:bg-black dark:border-white dark:text-white dark:placeholder:text-white h-[55px] p-3 rounded-[10px] border bg-[#EFF6F9] focus:ring-2 focus:ring-blue-500 appearance-none">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="relative w-full">
                                <input type="text" wire:model.live="amount" placeholder="0"
                                    class="w-full dark:bg-black dark:border-white  h-[60px] p-3 rounded-[12px] border focus:ring-2 bg-[#EFF6F9] focus:ring-blue-500 dark:text-white"
                ...
                this.closePicker();
                    ...
                    <div>
                        ...
                        <textarea rows="3" wire:model="description" placeholder="شرح تراکنش..."
                            class="w-full dark:border-white dark:placeholder:text-white p-3 rounded-[10px] border bg-[#EFF6F9]   focus:ring-2 focus:ring-blue-500 resize-none"></textarea>
                    </div>
                    ...
                    <div class="max-h-[650px] overflow-y-auto min-w-[800px]">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                            ...
                            <tbody>
                               ...
                               transition-colors">                                    <td class="px-2 py-3 vazir text-[18px] font-medium"><?php echo e($loop->iteration); ?></td>
                                    <td
...
</div><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/livewire/sarafi/newversion/buy-sell-currency.blade.php ENDPATH**/ ?>