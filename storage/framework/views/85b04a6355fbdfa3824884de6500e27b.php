...
<head>
    ...
    <style>
        ...
        /* برای حالت collapsed در دسکتاپ */
.sidebar-collapsed {
    display: none !important;
}

/* اطمینان از نمایش سایدبار در دسکتاپ */
    ...
    <div id="mainContent">
        <header
            ...
            <div class="flex items-center space-x-4 rtl:space-x-reverse gap-6 justify-center">
                <div class="text-[40px] text-[#353e73] font-bold amiri company-name"> شرکت <?php echo e(Auth::guard('tools')->user()->company_name); ?>
