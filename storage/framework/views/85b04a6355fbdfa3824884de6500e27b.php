...
<body class="vazir dark:text-white">
    ...
    <div id="loader">
        ...
        <div class="loader-container pulse">
            ...
            <div class="loader-text">صرافــی <?php echo e(Auth::guard('tools')->user()->company_name); ?></div>
    ...
    <div id="mainContent">
        <header
            ...
            <div class="flex items-center space-x-4 rtl:space-x-reverse gap-6 justify-center ">
                <div class="text-[40px] text-[#122EE1] font-bold yekan"><?php echo e(Auth::guard('tools')->user()->company_name); ?>
                    ...
                    <ul id="dropdownMenu"
                        ...
                        <li><a href="<?php echo e(route('set-locale', 'fa')); ?>"
                                class="locale-link flex items-center px-3 py-2 hover:bg-gray-100 cursor-pointer"><img
                                    src="<?php echo e(asset('assets/sarafi/all_icon/Flags.png')); ?>" class="w-5 h-5 ml-2" alt="fa">
                                فارسی</a></li>
                        <li><a href="<?php echo e(route('set-locale', 'ps')); ?>"
                                class="locale-link flex items-center px-3 py-2 hover:bg-gray-100 cursor-pointer"><img
                                    src="<?php echo e(asset('assets/sarafi/all_icon/Flags.png')); ?>" class="w-5 h-5 ml-2" alt="ps">
                                پشتو</a></li>
                    ...
                    <div id="profileDropdown" style="box-shadow: 0px 4px 4px 0px #00000040, 0 0 0 0 #3B82F6;"
                        ...
                        <div class="p-3 border-b space-y-5">
                            <div class="flex flex-col justify-center items-center ">
                                <img src="<?php echo e(asset('assets/sarafi/all_icon/man.png')); ?>" alt="" class="h-20 w-20">
