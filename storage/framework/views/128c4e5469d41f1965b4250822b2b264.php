...
<head>
    <meta charset="UTF-8">
    <title>تراکنش صرافی - <?php echo e($currentUser->sarafi_name ?? 'صرافی'); ?></title>
    <style>
...
<body>
<div class="document">
    <h1 style="text-align:center;" class="shabnam-fd">صرافی <?php echo e($currentUser->sarafi_name ?? 'صرافی'); ?></h1>
    ...
    <div class="header">
        <table style="width:100%; border-collapse: collapse;">
            ...
            <tr>
                <td style="text-align:center;">شماره احواله: <?php echo e($transaction->changerdeal->remittance_number ?? '-'); ?></td>
            </tr>
        </table>
    </div>
    ...
    <table class="info-table">
        ...
        <tr><td> از حساب: </td><td><?php echo e($transaction->changerdeal->fromCustomer->fullname ?? 'نامشخص'); ?></td></tr>
        <tr><td> به حساب: </td><td><?php echo e($transaction->changerdeal->toCustomer->fullname ?? 'نامشخص'); ?></td></tr>
        <tr><td> از صرافی: </td><td><?php echo e($transaction->changerdeal->fromSarafiUser->sarafi_name ?? 'نامشخص'); ?></td></tr>
        <tr><td> به صرافی: </td><td><?php echo e($transaction->changerdeal->toSarafiUser->sarafi_name ?? 'نامشخص'); ?></td></tr>
        <tr><td>نوع حساب:</td><td><?php echo e($transaction->account_type ?? 'نامشخص'); ?></td></tr>
        <tr><td>ارز:</td>
            <td><?php echo e($currenciesFa[strtolower($transaction->currency)] ?? $transaction->currency); ?> (<?php echo e(strtoupper($transaction->currency)); ?>)</td>
        </tr>
        <tr><td>مبلغ:</td><td><?php echo e(number_format((float)$transaction->amount)); ?></td></tr>
        <tr><td>تاریخ:</td><td><?php echo e(explode(' ', $transaction->date)[0] ?? $transaction->date); ?></td></tr>
        <tr><td>زمان:</td><td><?php echo e($transaction->created_at->format('H:i')); ?></td></tr>
        <tr><td>شناسه تراکنش:</td><td><?php echo e($transaction->id); ?></td></tr>
    </table>
    ...
    <div class="contact-info">
        <div class="contact-item"><strong>تماس:</strong> 93<?php echo e($currentUser->phone ?? '-'); ?>+</div>
        <div class="contact-item"><strong>آدرس:</strong> افغانستان <?php echo e($currentUser->address ?? '-'); ?></div>
    </div>
...
<?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/pdf/Sarafi/changersdeal.blade.php ENDPATH**/ ?>