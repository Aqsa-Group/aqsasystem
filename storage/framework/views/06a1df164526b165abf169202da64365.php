...
<body
    ...
    <div
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="width: 105mm; text-align: center; padding: 0 5px;">
                        <div style="margin-bottom: 3pt; font-size: 9pt;">سند گروی غرفه های فردوس پلازا!</div>
        ...
        <div style="font-size: 10.7pt; line-height: 1.8; text-align: justify; margin-bottom: 12pt;  color:black;">
            اینجانب <?php echo e($booth->customer?->fullname); ?> ولد <?php echo e($booth->customer->father_name); ?> ولدیت
            <?php echo e($booth->customer->grand_father); ?>

            دارنده نمبر تذکره (<?php echo e($booth->customer->id_number); ?>)، در حالی که دارای اهلیت کامل شرعی و قانونی خویش می‌باشم،
            غرفه واقع در طبقه (<?php echo e($booth->floor ?? '---'); ?>)
...
<?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/contracts/booth_grawi_Sell.blade.php ENDPATH**/ ?>