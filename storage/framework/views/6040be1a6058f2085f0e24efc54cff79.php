...
<body onload="window.print()">
    <div class="header">
        ...
        <div class="document-title">سند حسابداری - <?php echo e($accounting->expanses_type); ?></div>
    </div>
    ...
    <table class="info-table">
        ...
        <tr>
            ...
            <td><?php echo e($accounting->shopkeeper->name ?? '---'); ?></td>
            <td class="label">شماره دوکان:</td>
            <td><?php echo e($accounting->shop->name ?? $accounting->booth->name ?? '---'); ?></td>
        </tr>
        <tr>
            <td class="label">مبلغ:</td>
            <td><?php echo e(number_format($accounting->amount)); ?> افغانی</td>
            <td class="label">تاریخ:</td>
            <td><?php echo e(verta($accounting->created_at)->format('Y/m/d')); ?></td>
        </tr>
        <tr>
            <td class="label">توضیحات:</td>
            <td colspan="3"><?php echo e($accounting->description ?? '---'); ?></td>
        </tr>
    </table>
...
</html><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/print/general.blade.php ENDPATH**/ ?>