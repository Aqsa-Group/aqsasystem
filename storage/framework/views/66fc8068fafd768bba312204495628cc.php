...
<body
                ...
                <tr>
                    ...
                    <td style="width: 105mm; text-align: center; padding: 0 5px;">
                        <table style="width: 100%; border-collapse: collapse; margin: 0 auto; border: 1px solid #1e3a8a;">
                            ...
                            <tr>
                                <td style="border: 1px solid #1e3a8a; padding: 5px; text-align: center;"><?php echo e($staff->job); ?></td>
                                <td style="border: 1px solid #1e3a8a; padding: 5px; text-align: center;"><?php echo e(number_format($staff->salary)); ?></td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <img src="<?php echo e(public_path('storage/' . $staff->profile_image)); ?>" alt="امضاء کارمند"
                        style="width: 28mm; height: 28mm;" />
                </td>
                </tr>
            </table>
    ...
    <div style="font-size: 10.7pt; line-height: 1.8; text-align: justify;  color:black; margin-top: 10px;">
        اینجانب <?php echo e($staff->market->owner_name ?? 'حاجی محمد داود عادلیار'); ?> ولد <?php echo e($staff->market->owner_father_name ?? 'حاجی جمعه خان'); ?> ولدیت <?php echo e($staff->market->owner_grand_father ?? 'حیدرخان'); ?> دارنده نمبر تذکره <?php echo e($staff->market->owner_id_number ?? '۳۲۷۹۳۸۲'); ?> ج. ۲۲ ص ۱۸۷ نمبر ثبت ۴۹۲ در حالی که دارای اهلیت شرعی و قانونی خویش بوده و می‌باشم، <?php echo e($staff->fullname ?? 'مصطفی اکبری'); ?>، ساکن <?php echo e($staff->address ?? 'ناحیه ۲ سینما'); ?> را بعنوان <?php echo e($staff->job ?? 'صفاکار'); ?> در مارکت <?php echo e($staff->market->name ?? '_____'); ?>، به مدت <?php echo e($durationText); ?> استخدام نموده‌ام و ایشان این قرارداد را امضا نموده و متعهد می‌گردد در انجام وظایف محوله نهایت دقت و تلاش را به عمل آورد و تمامی مقررات داخلی مارکت را رعایت نماید. همچنین مارکت متعهد می‌گردد حقوق قانونی کارمند را به موقع پرداخت نماید.
    </div>
...
<?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/contracts/staff_contract.blade.php ENDPATH**/ ?>