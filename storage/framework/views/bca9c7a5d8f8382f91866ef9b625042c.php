                ...
                <td role="gridcell" aria-label="نسخه چپ">
                    ...
                    <div class="col-header" role="banner" style="position: relative; height: 100px;">
                        ...
                        <div
                            ...
                            <div class="title"
                                style="font-size: 26px; font-weight: bold; display: inline-flexbox">
...
<?php $__currentLoopData = $accounting->where('expanses_type', 'پول برق'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accounting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
        <td><?php echo e($i++); ?></td> 
    </tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                <td>
                    ...
                    <table style="width:100%; border-collapse:separate;  border-spacing:12px 0;">
                        <tr>
                            ...
                            <td style="width:62%; vertical-align: top; border:none !important; padding:0;">
                            ...
                            <!-- ستون مسؤول برق / مهر / نوت (عرض کمتر) -->
                            <td
                    ...
                    <table class="form-table" role="table" aria-label="مشخصات">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($accounting->market->name ?? '---'); ?></td>
                                <td><?php echo e($accounting->id); ?></td>
                                <td><?php echo e($accounting->shop->number ?? $accounting->booth->number ?? '---'); ?></td>
...
</html><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/prints/electricity.blade.php ENDPATH**/ ?>