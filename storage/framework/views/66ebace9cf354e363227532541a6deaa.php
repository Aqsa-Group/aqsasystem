...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mt-2 flex flex-col lg:flex-row gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-2 text-sm text-gray-600">
                                <strong>
                                    <?php echo e($receivedAmountInWords); ?>

                                </strong>

                            </div><?php echo e($receivedAmountInWords); ?>
...
</div><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/livewire/tools-panel/conversion-in-account.blade.php ENDPATH**/ ?>