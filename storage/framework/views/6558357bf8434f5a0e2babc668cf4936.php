                                ...
                                <tr class="text-black border-b border-[#D9D9D9] bg-transparent">
                                    ...
                                    <td class="px-1  py-3 vazir text-[13px] md:text-[16px] font-medium w-52">
                                        <div class="text-left">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($conversion->type === 'باتفاوت' && $conversion->tax_amount > 0): ?>
