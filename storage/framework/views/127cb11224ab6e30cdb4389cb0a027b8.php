    <div>
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pb-0 pt-1">
                ...
                <div class="bg-gradient-to-br from-orange-100 to-orange-200 border-l-4 border-orange-500 text-orange-800 p-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl">
                    <div class="flex items-center justify-between mb-4">
                ...
                <div class="bg-gradient-to-br from-teal-100 to-teal-200 border-l-4 border-teal-500 text-teal-800 p-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl">
                    <div class="flex items-center justify-between mb-4">
                ...
                <div class="bg-gradient-to-br from-indigo-100 to-indigo-200 border-l-4 border-indigo-500 text-indigo-800 p-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl">
                    <div class="flex items-center justify-between mb-4">
                ...
                <div class="bg-gradient-to-br from-pink-100 to-pink-200 border-l-4 border-pink-500 text-pink-800 p-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl">
                    <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex flex-col bg-[#F5F5F5] w-full lg:w-[474px] p-4 h-auto rounded-[12px] space-y-4"
                ...
                <form wire:submit.prevent="submitSalary" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div x-data="{
                            ...
                            <datalist id="staffsList">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $staffs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($staff->name); ?>">
                                        <?php echo e($staff->name); ?> - <?php echo e(number_format($staff->salary)); ?> افغانی
                                    </option>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['selectedStaff'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="flex-1 flex flex-col bg-[#F5F5F5] p-4 rounded-[12px] mt-8 lg:mt-0 md:mx-auto lg:mx-auto w-[540px] mb-5 md:w-[510px] lg:w-[200px]"
                ...
                <div class="flex flex-col md:flex-row justify-between items-center border border-[#8C8C8C] p-4 rounded-[12px] mb-4 gap-3">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedStaffId): ?>
                            <?php
                            ...
                            <div class="bg-blue-100 px-3 py-2 rounded-lg flex items-center gap-2">
                                <span class="text-blue-700 vazir">فیلتر: <?php echo e($selectedStaff->name ?? ''); ?></span>
                ...
                <div class="overflow-x-auto w-full">
                    <div class="max-h-[680px] overflow-y-auto min-w-[890px]">
                        <table class="w-full text-sm md:text-base text-left rtl:text-right text-gray-500">
                            <thead class="bg-gradient-to-br from-indigo-400 to-indigo-500 text-white text-[14px] md:text-[16px] lg:text-[18px] vazir h-[50px] md:h-[67px] sticky top-0">
                                <tr>
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $salaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $salary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="border-b border-[#D9D9D9] bg-transparent hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-4 py-4 vazir text-[14px] md:text-[16px] font-medium">
                                            <?php echo e($salary->staff->name ?? '-'); ?>

                                        </td>
                                        <td class="px-2 py-4 vazir text-[14px] md:text-[16px] font-medium">
                                            <?php echo e(number_format($salary->amount)); ?> <span class="text-sm text-gray-500">افغانی</span>
                                        </td>
                                        <td class="px-4 py-4 vazir text-[14px] md:text-[16px] font-medium text-center">
                                            <p class="text-sm"><?php echo e($salary->description ?? 'بدون توضیح'); ?></p>
                                        </td>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($confirmDeleteId): ?>
            <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                <div class="bg-white p-6 rounded-[12px] shadow-xl w-[90%] max-w-[653px] text-center animate-fadeIn z-50 border border-[#E1DED3] relative">
    ...
    </div><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/livewire/import/salary.blade.php ENDPATH**/ ?>