...
<head>
    <meta charset="UTF-8">
    <title>سند پرداخت معاش - <?php echo e($salary->staff->name); ?> <?php echo e($salary->staff->lastname); ?></title>
    <style>
...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <div class="company-name"><?php echo e($currentUser->company_name); ?></div>
            <div class="document-title">سند رسمی پرداخت معاش</div>
            <div class="employee-name"><?php echo e($salary->staff->name); ?> <?php echo e($salary->staff->lastname); ?></div>
        </div>
        ...
        <div class="content">
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span class="value"><?php echo e($salary->staff->name); ?> <?php echo e($salary->staff->lastname); ?></span>
                </div>
                <div class="info-row">
                    <span class="label">شغل:</span>
                    <span class="value"><?php echo e($salary->staff->job); ?></span>
                </div>
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span class="value"><?php echo e($salary->date); ?></span>
                </div>
                <div class="info-row">
                    <span class="label">واحد پولی:</span>
                    <span class="value">
                         <?php echo e($currenciesFa[strtolower($salary->currency)] ?? $salary->currency); ?>

                    (<?php echo e(strtoupper($salary->currency)); ?>)
                    </span>
                </div>
                <div class="info-row">
                    <span class="label">شماره سند:</span>
                    <span class="value">SAL-<?php echo e($salary->id); ?></span>
                </div>
            </div>
        ...
        <div class="footer">
            <div class="document-id">
                شناسه سند: PS-<?php echo e($salary->id); ?>-<?php echo e(date('Ymd', strtotime($salary->date))); ?>

            </div>
            <div class="print-date">
                چاپ شده در: <?php echo e(now()->format('Y/m/d - H:i')); ?>

            </div>
            <div class="barcode-area">
                <?php echo e($salary->id); ?><?php echo e(date('Ymd', strtotime($salary->date))); ?><?php echo e($salary->staff->id); ?>

            </div>
        </div>
    </div>
</body>
</html><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/pdf/Tools/salary-print.blade.php ENDPATH**/ ?>