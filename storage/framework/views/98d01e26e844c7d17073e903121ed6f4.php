...
<div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-7 mb-4 gap-4 items-stretch">
                            ...
                            <div class="relative">
                                <select wire:model.live="selectedCurrency" id="currencySelect"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <table
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $deals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                               ...
                               transition-colors">
                                    ...
                                    <td class="px-4 py-4 vazir text-[14px] md:text-[16px] font-medium w-48">
                                        <?php echo e($deal->fromCustomer->fullname); ?>
                                    ...
                                    <td class="px-4 py-4 vazir text-[14px] md:text-[16px] font-medium w-48">
                                        <?php echo e($deal->toCustomer->fullname); ?>

                                    </td>

                                    <td class="px-4 py-4 vazir text-[14px] md:text-[16px] font-medium w-48">
                                        <?php echo e($deal->remittance_number); ?>
                                    ...
                                    <td class="px-4 py-4 vazir text-[14px] md:tex    t-[16px] font-medium w-48">
                                        <?php echo e($deal->fromSarafiUser->sarafi_name); ?>
                                    ...
                                    <td class="px-4 py-4 vazir text-[14px] md:text-[16px] font-medium w-48">
                                        <?php echo e($deal->amount); ?>

                                    </td>


                                    <td class="px-4 py-4 vazir text-[14px] md:text-[16px] font-medium w-48">
                                        <?php echo e($currencies[$deal->currency] ?? strtoupper($deal->currency)); ?>
                                    ...
                                    <td class="px-4 py-4 vazir text-[14px] md:text-[16px] text-center w-40">
                                        <div class="whitespace-nowrap">
                                            <div class="font-medium">
                                                <?php echo e(explode(' ',$deal->date)[0]); ?>

                                            </div>
                                            <div class="text-gray-500 text-sm mt-1">
                                                <?php echo e(\Carbon\Carbon::parse($deal->created_at)->format('h:i A')); ?>
    ...
    </div><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/livewire/sarafi/changer-recive.blade.php ENDPATH**/ ?>