    ...
    <table class="test" style="width: 100%; border-collapse: collapse; border: none; margin-top: 10px;">
        <tr>
            ...
            <td style="border: none; text-align: left;">
                <small><?php echo e(jdate($loan->created_at)->format('Y/m/d H:i')); ?></small>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td>
                ...
                <?php elseif($loan->customer): ?>
                    <?php echo e($loan->customer->fullname); ?>

                <?php elseif($loan->shopkeeper): ?>
                    <?php echo e($loan->shopkeeper->fullname); ?>
...
<?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/exports/loanLog.blade.php ENDPATH**/ ?>