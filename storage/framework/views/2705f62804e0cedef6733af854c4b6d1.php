...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="w-full max-w-[1465px] bg-[#F5F5F5] rounded-[12px] mt-10 p-6 mx-auto"
            ...
            <table class="w-full text-sm md:text-base text-left mt-6 rtl:text-right text-gray-500 dark:text-gray-400">
                <thead
                    class="bg-gradient-to-br from-black to-blue-400  w-full text-white text-[14px] md:text-[16px] h-[50px] md:h-[67px] sticky top-0"
                    style="box-shadow: 0px 4px 4px 0px #00000040;">
                    <!-- سطر اول -->
                    <tr class="w-full">
...
</script><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/livewire/tools-panel/transactions-reports.blade.php ENDPATH**/ ?>