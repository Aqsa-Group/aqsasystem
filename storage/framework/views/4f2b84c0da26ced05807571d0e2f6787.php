                ...
                <form wire:submit.prevent="paySalary">
                    ...
                    <div class="mt-2 grid grid-cols-1 gap-3">
                        <div class="flex-1 w-full">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selectedStaffId'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="mt-3 p-3 border border-green-300 rounded-lg bg-green-50 dark:bg-green-900/20">
                            ...
                            <div class="grid grid-cols-2 gap-2 text-sm">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-semibold"><?php echo e($staffDetails->name); ?> <?php echo e($staffDetails->fathername); ?></span>
                                </div>
                                <div class="flex justify-between">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-semibold"><?php echo e(number_format($staffDetails->salary_amount)); ?> افغانی</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600 dark:text-gray-300">تاریخ شروع:</span>
                                    <span class="font-semibold"><?php echo e(explode(' ' , $staffDetails->contract_start)[0]); ?></span>
                                </div>
                                <div class="col-span-2 flex justify-between mt-1">
                                    <span class="text-gray-600 dark:text-gray-300">روزهای معوقه:</span>
                                    <span class="font-bold text-blue-600 dark:text-blue-400"><?php echo e($dueDays); ?> روز</span>
                                </div>
                                <div class="col-span-2 flex justify-between mt-1 border-t pt-1">
                                    ...
                                    <span class="font-bold text-lg text-green-600 dark:text-green-400"><?php echo e(number_format($dueAmount)); ?> افغانی</span>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($paymentMethod === 'کارتی'): ?>
            ...
            <div class="flex-1 flex flex-col dark:border dark:border-white dark:bg-black dark:text-white bg-[#F5F5F5] p-3 md:p-4 lg:p-6 rounded-[12px] w-full max-w-[440px] md:max-w-[410px] lg:max-w-full mb-5 mx-auto overflow-x-auto"
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 dark:border-white xl:grid-cols-2 justify-between items-center border border-[#8C8C8C] p-3 md:p-4 rounded-[12px] mb-3 gap-3">
                    ...
                    <div class="flex items-center gap-3">
                        <!--[if BLOCK]><![endif]--><?php if($selectedStaffId && $staffDetails): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $salaryHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $salary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="text-black border-b dark:text-white border-[#D9D9D9] bg-transparent">
                                        ...
                                        <td class="px-4 py-4 vazir text-[14px] md:text-[16px] font-medium w-32">
                                            <?php echo e(collect($currencies)->firstWhere('code', $salary->currency)['name_fa'] ?? $salary->currency); ?>
