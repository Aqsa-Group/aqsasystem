<div>
 ...
 <!-- Header Section -->
    ...
    <div class="w-full max-w-[1400px] mx-auto p-4">
        ...
        <!--[if BLOCK]><![endif]--><?php if($paymentMethod === 'کارتی' && $selectedCustomer): ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div dir="rtl"
                        ...
                        <div class="space-y-2">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($staffDetails->customer_id): ?>
                            <div class="flex justify-between">
                        ...
                        <div class="border-t pt-3">
                            ...
                            <div class="max-h-40 overflow-y-auto text-xs border rounded-lg">
                                <table class="w-full text-center">
                                    ...
                                    <tbody>
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $attendanceData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr
                    ...
                    <div class="mt-3 grid grid-cols-1 gap-3">
                        <div class="flex-1 w-full">
                            <div class="relative w-full">
                                <label class="block text-[16px] font-medium dark:text-white text-black mb-1 vazir">
                                    <!--[if BLOCK]><![endif]--><?php if($staffDetails && $staffDetails->customer_id): ?>
                                   کارت کارمند
                                    <?php else: ?>
                                    انتخاب کارت کارمند
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
