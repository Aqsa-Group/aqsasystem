        ...
        <table class="w-full text-sm md:text-base text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody class="text-[16px] md:text-[18px] text-gray-800 bg-white">
                <?php if(count($balances) > 0): ?>
                    ...
                    <?php $__currentLoopData = $balances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $balance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
