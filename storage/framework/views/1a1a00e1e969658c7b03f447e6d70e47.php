<div>
    ...
    <div class="overflow-x-auto shadow-md sm:rounded-lg w-full max-w-[420px] md:max-w-[800px] lg:max-w-[1268px] mx-auto dark:border dark:border-white dark:text-white bg-[#F5F5F5] dark:bg-black"
        ...
        <!-- 📊 Table -->
        <table
            class="w-[1268px] text-sm  overflow-x-auto   text-left rtl:text-right dark:bg-black text-gray-500 dark:text-white     ">
            ...
            <tbody>
                ...
                <tr class="border-b dark:bg-black dark:text-white ">
                    ...
                    <td class="px-6 py-4 text-[16px] text-black vazir dark:text-white"><?php echo e($customer->account_number ??
                        '-'); ?></td>
                    <td class="px-6 py-4 text-[16px] text-black vazir dark:text-white"><?php echo e($customer->type ?? '-'); ?></td>
                    <td class="px-6 py-4 text-[16px] text-black vazir dark:text-white"><?php echo e($customer->city); ?></td>
                    <td class="px-6 py-4 text-[16px] text-black vazir dark:text-white"><?php echo e($customer->phone); ?></td>
                    <td class="px-6 py-4 text-[16px] text-black vazir dark:text-white"><?php echo e($customer->idcard_number ??
                        '-'); ?></td>
                    <td class="px-6 py-4 text-[16px] text-black vazir dark:text-white"><?php echo e($customer->whatsapp_number ??
                        '-'); ?></td>
                    <td
                        class="px-6 py-4 text-[16px] text-black vazir dark:text-white flex space-x-2 rtl:space-x-reverse">
