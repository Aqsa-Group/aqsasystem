        ...
        <table class="w-[1268px] text-sm  overflow-x-auto   text-left rtl:text-right dark:bg-black text-gray-500 dark:text-white     ">
            ...
            <tbody>
                ...
                <tr class="border-b dark:bg-black dark:text-white ">
                    ...
                    <td class="px-6 py-4 text-[16px] text-black vazir dark:text-white"><?php echo e($customer->account_number ?? '-'); ?></td>
                    ...
                    <td class="px-6 py-4 text-[16px] text-black vazir dark:text-white"><?php echo e($customer->idcard_number ?? '-'); ?></td>
                    <td class="px-6 py-4 text-[16px] text-black vazir dark:text-white"><?php echo e($customer->whatsapp_number ?? '-'); ?></td>
