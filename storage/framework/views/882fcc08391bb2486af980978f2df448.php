            ...
            <div class="inline-block align-top ml-4 h-auto">
                <div
                    ...
                    <div x-data="{ 
                        ...
                        <?php else: ?>
                        <div class="flex justify-center mb-2">
                            <img src="<?php echo e(asset('assets/web.jpg')); ?>" alt="dark:bg-gradient-to-b dark:from-slate-500 dark:to-gray-900<?php echo e($withdrawalCustomer->fullname); ?>"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 mt-4">
                        ...
                        <div>
                            ...
                            <div class="mt-2 text-sm dark:text-white text-gray-600"><?php echo e($withdrawalAmountInWords); ?></div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
