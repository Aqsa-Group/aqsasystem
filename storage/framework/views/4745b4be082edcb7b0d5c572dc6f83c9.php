...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        animateNumbers.forEach(element => {
            ...
            const step = target / (duration / 16); // 16 میلی‌ثانیه برای هر فریم
            let current = 0;
...
<?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/livewire/tools-panel/dashboard.blade.php ENDPATH**/ ?>