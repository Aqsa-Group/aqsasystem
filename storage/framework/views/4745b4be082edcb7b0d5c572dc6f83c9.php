    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 p-4">
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p class="text-3xl font-bold mt-1 animate-number" data-target="<?php echo e($todaysale); ?>">0</p>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p class="text-3xl font-bold mt-1 animate-number" data-target="<?php echo e($todayprofit); ?>">0</p>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p class="text-3xl font-bold mt-1 animate-number vazir" data-target="<?php echo e($withdrawals); ?>">0</p>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p class="text-3xl font-bold mt-1 animate-number" data-target="<?php echo e($thismonthsale); ?>">0</p>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p class="text-3xl font-bold mt-1 animate-number" data-target="<?php echo e($inventorytotalprice); ?>">0</p>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p class="text-3xl font-bold mt-1 animate-number" data-target="<?php echo e($warehousetotalprice); ?>">0</p>
        ...
        <div
            ...
            <div class="flex items-end justify-between">
                <p class="text-3xl font-bold mt-1 animate-number" data-target="<?php echo e($totalstock); ?>">0</p>
            ...
            <div class="flex items-end justify-between">
                <div class="flex flex-col gap-2">
                    <div class="flex justify-center items-center text-2xl vazir ">
                        ...
                        <p class="text-3xl font-bold mt-1 animate-number vazir" data-target="<?php echo e($totalUsdLoan); ?>">0</p>
                    </div>
