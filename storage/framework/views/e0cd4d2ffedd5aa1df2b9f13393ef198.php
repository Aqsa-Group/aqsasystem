    ...
    <div class="page">
        <div class="card" role="main" aria-label="فرم پرداخت برق">
            <table class="two-col-table">
                <tr style="gap: 5px">
                    <!-- ستون راست -->
                    <td style="border: solid 1px black; padding: 20px;">
                        <div class="column column-right">
                            <div class="header">
                                ...
                                <div>
                                    <div style="font-size:12px; margin-top:4px;">
                                        مسلسل:
                                        <span><?php echo e($accounting->meter_serial); ?></span>
                                    </div>
                                </div>
                            </div>

                            <table class="form-table small-row" role="table" style="margin-top: 4px">
                                <thead>
                                    <tr>
                                    ...
                                    <table class="amount-rows">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($accounting->degree_price); ?></td>
                                            </tr>
                                            <tr>
                                                <td>مبلغ قابل پرداخت</td>
                                                <td><?php echo e($accounting->price); ?></td>
                                            </tr>
                                            <tr>
                                                <td>مبلغ پرداخت شده</td>
                                                <td><?php echo e($accounting->paid); ?></td>
                                            </tr>
                                            <tr>
                                                <td>باقیات</td>
                                                <td><?php echo e($accounting->remained); ?></td>
                                            </tr>
                                        </tbody>
                            ...
                            <!-- باکس سه‌ستونه زیر از تاریخ / تا تاریخ -->
...
</html><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/exports/accounting_electricity_print.blade.php ENDPATH**/ ?>