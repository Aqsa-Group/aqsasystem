    ...
    <table class="test" style="width: 100%; border-collapse: collapse; border: none; margin-top: 10px;">
        <tr>
            ...
            <td style="border: none; text-align: left;">
                <small><?php echo e(jdate($amount->created_at)->format('Y/m/d H:i')); ?></small>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td>
                ...
                <?php elseif($amount->customer): ?>
                    <?php echo e($amount->customer->fullname); ?>

                <?php elseif($amount->shopkeeper): ?>
                    <?php echo e($amount->shopkeeper->fullname); ?>
...
<?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/exports/paymentlog.blade.php ENDPATH**/ ?>