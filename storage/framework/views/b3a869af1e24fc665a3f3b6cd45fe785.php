...
<head>
    ...
    <title>فاکتور فروش - <?php echo e($sale->invoice_number); ?></title>
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl mx-auto">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="text-left">
                    <div class="bg-white text-blue-800 px-4 py-2 rounded-lg text-center">
                        ...
                        <div class="text-xl font-bold"><?php echo e($sale->invoice_number); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="p-8">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-bold"><?php echo e($sale->buyer_name); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">نوع فروش:</span>
                            <span class="font-bold <?php echo e($sale->sale_type === 'wholesale' ? 'text-green-600' : 'text-red-600'); ?>">
                                <?php echo e($sale->sale_type === 'wholesale' ? 'عمده' : 'پرچون'); ?>
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-bold"><?php echo e(jdate($sale->created_at)->format('Y/m/d H:i')); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">کاربر ثبت‌کننده:</span>
                            <span class="font-bold"><?php echo e($sale->user->name ?? 'سیستم'); ?></span>
                        </div>
                        <div class="flex justify-between">
                    ...
                    <table class="w-full text-sm border-collapse border border-gray-300">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="border border-gray-300 p-3 text-center"><?php echo e($item->barcode); ?></td>
                                <td class="border border-gray-300 p-3 text-center"><?php echo e(number_format($item->quantity)); ?></td>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center border-t border-blue-200 pt-3">
                            ...
                            <span class="text-2xl font-extrabold text-green-700">
                                <?php echo e(number_format($sale->total_price - $sale->discount, 3)); ?> دالر
                            </span>
                        </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-lg font-bold text-green-700">
                                <?php echo e(number_format($sale->items->sum('profit'), 3)); ?> دالر
                            </span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-red-600">مجموع زیان:</span>
                            <span class="text-lg font-bold text-red-600">
                                <?php echo e(number_format($sale->items->sum('loss'), 3)); ?> دالر
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-300 text-center text-gray-600 text-sm">
                ...
                <p class="mt-1">تاریخ چاپ: <?php echo e(jdate()->format('Y/m/d H:i')); ?></p>
            </div>
        </div>
    </div>
...
</html><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/tools/invoices/print.blade.php ENDPATH**/ ?>