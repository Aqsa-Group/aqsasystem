        ...
        <table style="width:100%; border-collapse: collapse; font-size: 8px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="border:1px solid #ddd; padding:3px; text-align:right;"><?php echo e(number_format($row['af'])); ?>

                    </td>
                    <td style="border:1px solid #ddd; padding:3px; text-align:right;"><?php echo e(number_format($row['us'])); ?>

                    </td>
                    <td style="border:1px solid #ddd; padding:3px; text-align:right;"><?php echo e(number_format($row['er'])); ?>

                    </td>
                    <td style="border:1px solid #ddd; padding:3px; text-align:right;"><?php echo e(number_format($row['ir'])); ?>
