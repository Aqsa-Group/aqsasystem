        ...
        <div class="loader-container pulse">
            <div class="spinner-wrapper">
                ...
                <div class="logo-loader">
                    <span><?php echo e(mb_substr(Auth::guard('market')->user()->market_name, 0, 1)); ?></span>
                </div>
            </div>

            <div class="loader-text">مدیریت مارکت <?php echo e(Auth::guard('market')->user()->market_name); ?></div>
...
>
                ...
                <nav class="mt-0 space-y-0" x-data="{
                    ...
                    <p class="text-center p-4 nastaliq text-[46px] text-[#03326C] "><?php echo e(Auth::guard('market')->user()->market_name); ?>

                    </p>
                    <!-- داشبورد -->
                    <a href="<?php echo e(route('market.home')); ?>"
...
</html><?php /**PATH /home/safiullah/Documents/GitHub/AqsaSystem/resources/views/Market/layouts/sidebar.blade.php ENDPATH**/ ?>