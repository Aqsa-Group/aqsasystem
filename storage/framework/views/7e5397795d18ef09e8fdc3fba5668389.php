    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <div class="border bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition hover:bg-cyan-50">
            <div class="flex items-center justify-center gap-2 text-gray-700">
                ...
                <a href="" class="font-medium text-sm"><?php echo e(__('messages.recipt/withdraw')); ?></a>
            </div>
        </div>
        ...
        <div class="border bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition hover:bg-cyan-50">
            <div class="flex items-center justify-center gap-2 text-gray-700">
                ...
                <a href="" class="font-medium text-sm"><?php echo e(__('messages.transfer')); ?></a>
            </div>
        </div>
        ...
        <div class="border bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition hover:bg-cyan-50">
            <div class="flex items-center justify-center gap-2 text-gray-700">
                ...
                <a href="" class="font-medium text-sm"><?php echo e(__('messages.newspaper_accounts')); ?></a>
            </div>
        </div>

        <div class="border bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition hover:bg-cyan-50">
            <div class="flex items-center justify-center gap-2 text-gray-700">
                <img src="<?php echo e(asset('assets/sarafi/exchange_money.png')); ?>" class="h-6 w-6" alt="">
                <a href="" class="font-medium text-sm"><?php echo e(__('messages.coversion_account')); ?></a>
            </div>
        </div>
        ...
        <div class="border bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition hover:bg-cyan-50">
            <div class="flex items-center justify-center gap-2 text-gray-700">
                ...
                <a href="" class="font-medium text-sm"><?php echo e(__('messages.coversion_transfer')); ?></a>
            </div>
        </div>

        <div class="border bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition hover:bg-cyan-50">
            <div class="flex items-center justify-center gap-2 text-gray-700">
                <img src="<?php echo e(asset('assets/sarafi/general.png')); ?>" class="h-6 w-6" alt="">
                <a href="" class="font-medium text-sm"><?php echo e(__('messages.general_jornal')); ?></a>
            </div>
        </div>
    </div>
                    ...
                    <div class="border bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition transform hover:scale-105">
                        <div class="flex items-center gap-4">
                            <div class="flex items-center justify-center bg-gradient-to-r from-indigo-500 to-blue-500 text-white rounded-full h-16 w-16 shadow-lg">
                                <img src="<?php echo e(asset('assets/sarafi/user.png')); ?>" alt="Users" class="h-10 w-10">
                            </div>
                            <div>
                    ...
                    <div class="border bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition transform hover:scale-105">
                        <div class="flex items-center gap-4">
                            <div class="flex items-center justify-center bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-full h-16 w-16 shadow-lg">
                                <img src="<?php echo e(asset('assets/sarafi/customer.png')); ?>" alt="Customers" class="h-10 w-10">
                            </div>
                            <div>
                    ...
                    <div class="border bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition transform hover:scale-105">
                        <div class="flex items-center gap-4">
                            <div class="flex items-center justify-center bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full h-16 w-16 shadow-lg">
                                <img src="<?php echo e(asset('assets/sarafi/transaction_s.png')); ?>" alt="Transactions" class="h-10 w-10">
                            </div>
                            <div>
                    ...
                    <div class="border bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition transform hover:scale-105">
                        <div class="flex items-center gap-4">
                            <div class="flex items-center justify-center bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-full h-16 w-16 shadow-lg">
                                <img src="<?php echo e(asset('assets/sarafi/transaction_w.png')); ?>" alt="Pending" class="h-10 w-10">
                            </div>
                            <div>
