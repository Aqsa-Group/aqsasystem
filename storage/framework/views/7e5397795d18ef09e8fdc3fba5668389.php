<div class="p-6 border-[#8C8C8C] min-h-screen" style="font-family: 'header';">
 ...
 text-white">
                        ...
                        <h1 class="text-lg font-semibold drop-shadow-md text-center"><?php echo e(__('messages.general_customers')); ?></h1>
 ...
 text-white">
                        ...
                        <h1 class="text-lg font-semibold drop-shadow-md text-center"><?php echo e(__('messages.general_today_transactions')); ?></h1>
 ...
 text-white">
                        ...
                        <h1 class="text-lg font-semibold drop-shadow-md text-center"><?php echo e(__('messages.general_pending_transactions')); ?></h1>
 ...
 text-white">
                        ...
                        <h1 class="text-lg font-semibold drop-shadow-md text-center"><?php echo e(__('messages.general_today_profit')); ?></h1>
 ...
 text-white">
                        ...
                        <h1 class="text-lg font-semibold drop-shadow-md text-center"><?php echo e(__('messages.general_total_transactions')); ?></h1>
 ...
 text-white">
                        ...
                        <h1 class="text-lg font-semibold drop-shadow-md text-center"><?php echo e(__('messages.general_remittances')); ?></h1>
 ...
 text-white">
                        ...
                        <h1 class="text-lg font-semibold drop-shadow-md text-center"><?php echo e(__('messages.general_total_balance')); ?></h1>
            ...
            <template x-if="activeTab === 'safes'">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    ...
                    <div
                        ...
                        <img src="<?php echo e(asset('assets/sarafi/currency/afn.jpg')); ?>" alt="AFN"
                    ...
                    <div
                        class="border bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition transform hover:scale-105 h-36 flex items-center gap-4">
                        <img src="<?php echo e(asset('assets/sarafi/currency/usd.png')); ?>" alt="USD"
                            class="h-14 w-14 rounded-full shadow-md">
                        <div>
                    ...
                    <div
                        class="border bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition transform hover:scale-105 h-36 flex items-center gap-4">
                        <img src="<?php echo e(asset('assets/sarafi/currency/eur.png')); ?>" alt="EUR"
                            class="h-14 w-14 rounded-full shadow-md">
                        <div>
                    ...
                    <div
                        class="border bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition transform hover:scale-105 h-36 flex items-center gap-4">
                        <img src="<?php echo e(asset('assets/sarafi/currency/irr.jpg')); ?>" alt="IRR"
                            class="h-14 w-14 rounded-full shadow-md">
                        <div>
                    ...
                    <div
                        class="border bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition transform hover:scale-105 h-36 flex items-center gap-4">
                        <img src="<?php echo e(asset('assets/sarafi/currency/aed.jpg')); ?>" alt="AED"
                            class="h-14 w-14 rounded-full shadow-md">
                        <div>
                    ...
                    <div
                        class="border bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition transform hover:scale-105 h-36 flex items-center gap-4">
                        <img src="<?php echo e(asset('assets/sarafi/currency/try.webp')); ?>" alt="TRY"
                            class="h-14 w-14 rounded-full shadow-md">
                        <div>
                    ...
                    <div
                        class="border bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition transform hover:scale-105 h-36 flex items-center gap-4">
                        <img src="<?php echo e(asset('assets/sarafi/currency/cny.jpeg')); ?>" alt="CNY"
                            class="h-14 w-14 rounded-full shadow-md">
                        <div>
                    ...
                    <div
                        class="border bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition transform hover:scale-105 h-36 flex items-center gap-4">
                        <img src="<?php echo e(asset('assets/sarafi/currency/pk.jpg')); ?>" alt="PKR"
                            class="h-14 w-14 rounded-full shadow-md">
                        <div>
                    ...
                    <div
                        class="border bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition transform hover:scale-105 h-36 flex items-center gap-4">
                        <img src="<?php echo e(asset('assets/sarafi/currency/gbp.png')); ?>" alt="GBP"
                            class="h-14 w-14 rounded-full shadow-md">
                        <div>
                    ...
                    <div
                        class="border bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition transform hover:scale-105 h-36 flex items-center gap-4">
                        <img src="<?php echo e(asset('assets/sarafi/currency/jpy.jpg')); ?>" alt="JPY"
                            class="h-14 w-14 rounded-full shadow-md">
                        <div>
                    ...
                    <div
                        class="border bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition transform hover:scale-105 h-36 flex items-center gap-4">
                        <img src="<?php echo e(asset('assets/sarafi/currency/sar.webp')); ?>" alt="SAR"
                            class="h-14 w-14 rounded-full shadow-md">
                        <div>
                    ...
                    <div
                        class="border bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition transform hover:scale-105 h-36 flex items-center gap-4">
                        <img src="<?php echo e(asset('assets/sarafi/currency/inr.jpg')); ?>" alt="INR"
                            class="h-14 w-14 rounded-full shadow-md">
                        <div>
