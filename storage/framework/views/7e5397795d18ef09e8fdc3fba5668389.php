    ...
    <div class="grid grid-cols-1 md:grid-cols-6 gap-2 items-center justify-center ">
        ...
        <div
            ...
            <div class="flex items-center justify-center gap-2">
                ...
                <a href="" class="text-[15px]"><?php echo e(__('messages.recipt/withdraw')); ?></a>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex items-center justify-center gap-2">
                ...
                <a href="" class="text-[15px]"><?php echo e(__('messages.transfer')); ?></a>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex items-center justify-center gap-2">
                ...
                <a href="" class="text-[15px]"><?php echo e(__('messages.newspaper_accounts')); ?></a>
            </div>
        </div>
        ...
        <div
            class="border bg-white border-gray-300 rounded-md p-3 shadow-sm hover:bg-cyan-400 transition-colors duration-300  ease-linear ">
            <div class="flex items-center justify-center gap-2">
                <img src="<?php echo e(asset('assets/sarafi/exchange_money.png')); ?>" class="h-7 w-7" alt="">
                <a href="" class="text-[15px]"><?php echo e(__('messages.coversion_account')); ?></a>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex items-center justify-center gap-2">
                <i class="fa-solid fa-money-bill-transfer"></i>
                <a href="" class="text-[15px]"><?php echo e(__('messages.coversion_transfer')); ?></a>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex items-center justify-center gap-2">
                ...
                <a href="" class="text-[15px]"><?php echo e(__('messages.general_jornal')); ?></a>
            </div>
        </div>
    </div>

    <div x-data="{ activeTab: <?php if ((object) ('activeTab') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('activeTab'->value()); ?>')<?php echo e('activeTab'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('activeTab'); ?>')<?php endif; ?> }" class="mt-14 border-gray-200" style="font-family: 'header';">
