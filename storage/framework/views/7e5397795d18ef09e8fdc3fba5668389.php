<div class="border-[#8C8C8C] min-h-screen" style="font-family: 'header';">
    ...
    <div class="grid grid-cols-1   md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4 vazir w-full "
        ...
        <!-- برد بانکی -->
        <a href="<?php echo e(route('sarafi.external')); ?>" class="block">
            <div style="box-shadow: -1px 4px 4px 0px rgba(37, 99, 235, 0.25);" class="group border bg-white
                rounded-xl py-3 px-6 flex items-center justify-center gap-[10px] 
                text-[#184D6C] text-[0.875rem] hover:bg-[#184D6C] hover:text-white transition-transform ease-linear">
                ...
                <svg width="24" height="24" class="block group-hover:hidden" viewBox="0 0 24 24" fill="none"
                ...
                <svg width="24" class="hidden group-hover:block" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M5.49994 2H4.09994C3.09994 2 2.59994 3.1 3.29994 3.8L8.99994 9.5C10.5999 11.1 13.2999 11.1 14.8999 9.5L20.5999 3.8C21.3999 3.1 20.8999 2 19.8999 2H18.4999C17.6999 2 16.8999 2.3 16.2999 2.9L12.6999 6.5C12.2999 6.9 11.5999 6.9 11.1999 6.5L7.69994 2.9C7.09994 2.3 6.29994 2 5.49994 2Z"
                        stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
        ...
        'bg-[#184D6C] h-f shadow-[0_0_4px_rgba(0,0,0,0.25)_0_4px_4px_rgba(0,0,0,0.25)]': activeTab === 'safes' || activeTab === 'account_safe'
            ...
            group-hover:bg-white ">
                ...
                group-hover:text-[#1A7477]">
                                    آخرین به‌روزرسانی <?php echo e($LastUserTime); ?>
 ...
 w-full   p-2 md:p-6 lg:p-6 transform transition-colors duration-500 ease-in-out
            ...
            group-hover:bg-white">
                ...
                group-hover:text-[#2563EB]">
                                    آخرین به‌روزرسانی <?php echo e($LastCustomerTime); ?>
            ...
            group-hover:bg-white">
                ...
                group-hover:text-[#EC4E19]">
                                    آخرین به‌روزرسانی <?php echo e($LastTransactionTime); ?> </p>
                            </div>
                        </div>
                    </div>
         ...
         w-full   p-3 md:p-6 lg:p-6 transform 
            ...
            group-hover:bg-white">
                ...
                group-hover:text-[#5474BB]">
                                    آخرین به‌روزرسانی <?php echo e($LastRemittanceTime); ?> </p>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($waitting > 0): ?>
 ...
 w-full   p-3 md:p-6 lg:p-6 transform 
            ...
            group-hover:bg-white">
                ...
                group-hover:text-[#EBA925]">
                                        آخرین به‌روزرسانی <?php echo e($LastRemittanceApprovalTime); ?>
            ...
            group-hover:bg-white">
                ...
                group-hover:text-[#108614]">
                                    آخرین به‌روزرسانی <?php echo e($LastProfitTime); ?>
            ...
            group-hover:bg-white">
                ...
                group-hover:text-[#DD2424]">
                                    آخرین به‌روزرسانی <?php echo e($LastLostTime); ?>
            ...
            group-hover:text-white">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentUser && in_array($currentUser->role, ['superadmin', 'admin', 'cashier'])): ?>
            ...
            <template x-if="activeTab === 'safes'">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 vazir ">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
