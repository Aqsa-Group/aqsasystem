            ...
            <form wire:submit.prevent="submit">
                <div class="flex flex-col md:flex-row gap-4 mb-4">
                    <div class="flex-1 relative">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['source_currency'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $formCurrencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr class="border-b">
        ...
        <td class="px-4 py-2">
            <input type="text" wire:model="formData.<?php echo e($currency); ?>.buy"
                ...
                placeholder="0.00">
            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['formData.'.$currency.'.buy'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <td class="px-4 py-2">
            <input type="text" wire:model="formData.<?php echo e($currency); ?>.sell"
                class="w-full outline-none bg-transparent rounded px-2 py-1 text-right"
                placeholder="0.00">
            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['formData.'.$currency.'.sell'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <table
                    ...
                    <thead class="bg-[#2B65E5] text-white">
                        <tr>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $tableCurrencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
