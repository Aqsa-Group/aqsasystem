...
<head>
    <meta charset="UTF-8" />
    <title>سند کرایه عادلیار - غرفه</title>
</head>
    ...
    <div
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="width: 105mm; text-align: center; padding: 0 5px;">
                        <div style="margin-bottom: 3pt; font-size: 9pt;">سند کرایه خط غرفه های فردوس پلازا!</div>
        ...
        <div style="font-size: 10pt; margin-bottom: 18pt; color:black;">
            ...
            <div style="margin-top: 6pt; padding-right: 16pt; line-height: 1.6;">
                ...
                <p style="margin-bottom: 2pt;">۴- تسلیمی غرفه یا اتاق به مالک در ختم قرارداد.</p>
