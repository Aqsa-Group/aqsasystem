        ...
        <table
            ...
            <tbody>
                ...
                <tr class="border-b dark:bg-black dark:text-white ">
                    ...
                    <td class="px-6 py-4 text-[16px] text-black vazir dark:text-white">{{ $customer->account_number ??
                        '-' }}</td>
                    ...
                    <td class="px-6 py-4 text-[16px] text-black vazir dark:text-white">{{ $customer->idcard_number ??
                        '-' }}</td>
                    <td class="px-6 py-4 text-[16px] text-black vazir dark:text-white">{{ $customer->whatsapp_number ??
                        '-' }}</td>
                    <td
