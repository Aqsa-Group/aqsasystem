                ...
                <form wire:submit.prevent="submitConversion" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 mt-4">
                        ...
                        <div>
                            ...
                            <div class="mt-2 text-sm dark:text-white text-gray-600">{{ $commissionAmountInWords }}</div>
                            @endif
            ...
            <tbody>
                ...
                <tr class="text-black dark:text-white border-b border-[#D9D9D9]">
                    ...
                    <td class="px-2 py-3 text-left">
                        {{ number_format($conversion->withdrawal_amount) }} {{ $this->getCurrencyName($conversion->from_currency) }}
                    </td>
                    <td class="px-2 py-3 text-left">
                        {{ number_format($conversion->received_amount) }} {{ $this->getCurrencyName($conversion->from_currency) }}
                    </td>
                    ...
                    <td class="px-2 py-3 text-center">
                        <div class="flex justify-center gap-2">
                            ...
                            <button wire:click="printTransaction({{ $conversion->id }})" title="پرینت PDF">
                                <img src="{{ asset('assets/sarafi/all_icon/print_table.svg') }}" class="w-6 h-6" alt="Print">
                            </button>
                        </div>
                    </td>
                </tr>
