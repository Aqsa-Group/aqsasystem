<div class="border-[#8C8C8C] min-h-screen" style="font-family: 'header';">
   ...
   <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-3 p-2">
    ...
    <!-- رسید/بردگی -->
    <a href="{{ route('sarafi.transactions') }}" class="group block">
    ...
    <!-- انتقال -->
    <a href="{{ route('sarafi.account_to_account') }}" class="group block">
    ...
    <a href="{{ route('sarafi.buy-sell-currency') }}" class="group block">
    ...
    <!-- حساب تبدیل -->
    <a href="{{ route('sarafi.conversion.in.account') }}" class="group block">
    ...
    <!-- انتقال تبدیل -->
    <a href="{{ route('sarafi.conversion-transfer') }}" class="group block">
    ...
    <!-- رسید بانکی -->
    <a href="{{ route('sarafi.remittance') }}" class="group block">
    ...
    <!-- برد بانکی -->
    <a href="{{ route('sarafi.withdrawbank') }}" class="group block">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 p-4">
        ...
        <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-700 p-6 shadow-lg transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-500/30">
            ...
            <div class="relative z-10 flex flex-col h-full">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <span class="text-xs font-semibold text-white/70">{{ __('messages.general_users') }}</span>
                </div>
                
                <div class="mt-auto">
                    <p class="text-4xl font-bold text-white tracking-tight">{{ $UserCount }}</p>
        ...
        <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-500 via-emerald-600 to-green-700 p-6 shadow-lg transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-emerald-500/30">
            ...
            <div class="relative z-10 flex flex-col h-full">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <span class="text-xs font-semibold text-white/70">{{ __('messages.general_customers') }}</span>
                </div>
                
                <div class="mt-auto">
                    <p class="text-4xl font-bold text-white tracking-tight">{{ $customerCount }}</p>
                    <div class="mt-2 flex items-center text-sm text-white/80">
                        <svg class="mr-1 h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500 via-purple-600 to-indigo-700 p-6 shadow-lg transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/30">
            ...
            <div class="relative z-10 flex flex-col h-full">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <span class="text-xs font-semibold text-white/70">{{ __('messages.general_today_transactions') }}</span>
                </div>
                
                <div class="mt-auto">
                    <p class="text-4xl font-bold text-white tracking-tight">{{ $TransactionCount }}</p>
                    <div class="mt-2 flex items-center text-sm text-white/80">
                        <svg class="mr-1 h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500 via-orange-600 to-red-600 p-6 shadow-lg transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-orange-500/30">
            ...
            <div class="relative z-10 flex flex-col h-full">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <span class="text-xs font-semibold text-white/70">{{ __('messages.general_remittances') }}</span>
                </div>
                
                <div class="mt-auto">
                    <p class="text-4xl font-bold text-white tracking-tight">{{ $remittancecount }}</p>
                    <div class="mt-2 flex items-center text-sm text-white/80">
                        <svg class="mr-1 h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <!-- حواله‌های در انتظار -->
        @if($waitting > 0)
        <a href="{{ route('sarafi.remittance-approval') }}" class="block">
        @endif
        <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-rose-500 via-pink-600 to-rose-700 p-6 shadow-lg transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-rose-500/30 @if($waitting > 0) cursor-pointer hover:border-2 hover:border-white/30 @endif">
            <div class="absolute -right-4 -top-4 h-24 w-24 rounded-full bg-white/10"></div>
            <div class="absolute -bottom-4 -left-4 h-20 w-20 rounded-full bg-white/5"></div>
            ...
            <div class="relative z-10 flex flex-col h-full">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <span class="text-xs font-semibold text-white/70">{{ __('messages.general_pending_transactions') }}</span>
                </div>
                
                <div class="mt-auto">
                    <p class="text-4xl font-bold text-white tracking-tight">{{ $waitting }}</p>
        ...
        <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-500 via-teal-600 to-emerald-700 p-6 shadow-lg transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-green-500/30">
            ...
            <div class="relative z-10 flex flex-col h-full">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <span class="text-xs font-semibold text-white/70">{{ __('messages.general_today_profit') }}</span>
                </div>
                
                <div class="mt-auto">
                    <p class="text-4xl font-bold text-white tracking-tight">${{ number_format($todayprofit, 2) }}</p>
                    <div class="mt-2 flex items-center text-sm text-white/80">
                        <svg class="mr-1 h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-500 via-red-600 to-rose-700 p-6 shadow-lg transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-red-500/30">
            ...
            <div class="relative z-10 flex flex-col h-full">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <span class="text-xs font-semibold text-white/70">{{ __('messages.general_today_lost') }}</span>
                </div>
                
                <div class="mt-auto">
                    <p class="text-4xl font-bold text-white tracking-tight">${{ number_format($todaylost, 2) }}</p>
                    <div class="mt-2 flex items-center text-sm text-white/80">
                        <svg class="mr-1 h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-700 via-gray-800 to-slate-900 p-6 shadow-lg transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-slate-500/30">
            ...
            <div class="relative z-10 flex flex-col h-full">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <span class="text-xs font-semibold text-white/70">{{ __('messages.general_total_balance') }}</span>
                </div>
                
                <div class="mt-auto">
                    <p class="text-4xl font-bold text-white tracking-tight" dir="ltr">${{ number_format($total_balance_usd, 2) }}</p>
                    <div class="mt-2 flex items-center text-sm text-white/80">
                        <svg class="mr-1 h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
