<div class="border-[#8C8C8C] min-h-screen" style="font-family: 'header';">
    ...
    <div class="grid grid-cols-1   md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4 vazir w-full "
        ...
        <!--  معاملات بیرونی -->
        <a href="{{ route('sarafi.external') }}" class="block">
            <div style="box-shadow: -1px 4px 4px 0px rgba(37, 99, 235, 0.25);" class="group border bg-white
                rounded-xl py-3 px-6 flex items-center justify-center gap-[10px] 
                text-[#184D6C] text-[0.875rem] hover:bg-[#184D6C] hover:text-white transition-transform ease-linear">
        ...
        <!--   تبادله بین صندوق ها -->
        <a href="{{ route('sarafi.safe_deals') }}" class="block">
            <div style="box-shadow: -1px 4px 4px 0px rgba(37, 99, 235, 0.25);" class="group border bg-white
                rounded-xl py-3 px-6 flex items-center justify-center gap-[10px] 
                text-[#184D6C] text-[0.875rem] hover:bg-[#184D6C] hover:text-white transition-transform ease-linear">
    ...
    <div x-data="{ activeTab: @entangle('activeTab') }" class="mt-12">
      ...
      ? ' text-black tab-active-shadow'
        : 'border-transparent text-gray-500  hover:text-black'">
                ...
                <span class="font-bold">{{ __('messages.tab_general') }}</span>
            </a>
        ...
        : 'border-transparent text-gray-500  hover:text-black'">
                ...
                <span class="font-bold">{{ __('messages.tab_safes') }}</span>
            </a>
        ...
        : 'border-transparent text-gray-500  hover:text-black'">
                ...
                <span class="font-bold">{{ __('messages.account_safes') }}</span>
            </a>
         ...
         w-full   p-3 md:p-6 lg:p-6 transform 
            ...
            group-hover:bg-white">
                ...
                group-hover:text-[#5474BB]">
                    ...
                    @if($waitting > 0)
                    <a href="{{ route('sarafi.remittance-approval') }}" class="w-full">
                        @endif
                        <div class="group flex flex-col justify-between border rounded-2xl
 ...
 w-full   p-3 md:p-6 lg:p-6 transform 
            ...
            group-hover:text-white">
                                ...
                                @if($currentUser && in_array($currentUser->role, ['superadmin', 'admin', 'cashier']))
