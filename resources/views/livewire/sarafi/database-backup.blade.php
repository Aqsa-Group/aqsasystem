                            ...
                            <label for="sqlFileInput" class="block w-full px-4 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 border-2 border-dashed border-blue-300 dark:border-blue-700 hover:border-blue-400 dark:hover:border-blue-600 rounded-lg cursor-pointer transition-colors duration-200">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    @else
                                        ...
                                        <span class="text-green-600 dark:text-green-400 font-medium">{{ $sqlFile->getClientOriginalName() }}</span>
                                        <span class="text-gray-500 dark:text-gray-400 text-xs mt-1">{{ round($sqlFile->getSize() / 1024, 2) }} KB</span>
                                    @endif
                                </div>
                            </label>
                        </div>
            ...
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 dark:text-white">بازیابی اطلاعات</h3>
                            <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">{{ $importStatus }}</p>
                        </div>
                    </div>
            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    <div class="flex justify-between mb-2">
                        ...
                        <span class="text-sm font-medium text-blue-600 dark:text-blue-400">{{ $importProgress }}%</span>
                    </div>
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                        <div 
                            class="h-2.5 rounded-full transition-all duration-300 {{ $importProgress === 100 ? 'bg-green-500' : 'bg-gradient-to-r from-blue-500 to-indigo-600' }}"
                ...
                <div class="mb-6">
                    <div class="flex items-center p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                        ...
                        @else
                            @if(str_contains($importStatus, 'موفق'))
                            ...
                            @endif
                        @endif
                        <span class="text-gray-700 dark:text-gray-300 mr-2">{{ $importStatus }}</span>
                    </div>
                </div>
