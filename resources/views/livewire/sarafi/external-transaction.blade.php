                ...
                <form wire:submit.prevent="submitConversion">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 justify-center items-center gap-4 py-4">
                        ...
                        <div class="mt-2">
                            ...
                            @if($withdrawSafeAmountInWords)
                            <div class="mt-2 text-sm text-gray-600 dark:text-white">
                                <strong></strong> {{ $withdrawSafeAmountInWords }}
                            </div>
                            @endif
                            @error('withdraw_safe_amount')
                            <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <table class="w-full text-sm md:text-base text-left rtl:text-right text-gray-500">
                            ...
                            <tbody>
                               ...
                               transition-colors">
                                    ...
                                    <td class="px-1 py-3 vazir text-[13px] md:text-[18px] w-44">
                                        {{ number_format($conversion->withdraw_safe_amount, 2) }}
                                    </td>
