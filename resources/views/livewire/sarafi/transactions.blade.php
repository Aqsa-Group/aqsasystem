    ...
    <div class="container mx-auto px-0 ">
        ...
        <div class="flex flex-col lg:flex-row gap-5 mt-4">
            ...
            <div class="flex-1 flex flex-col
                ...
                <table
                    class="w-full table-fixed text-sm md:text-base text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        odd:bg-[#EFF6F9] even:bg-white dark:odd:bg-[#1E293B] dark:even:bg-black
                            ...
                            <!-- ردیف -->
                            <td
                                class="px-2 py-2 vazir text-[14px] md:text-[16px] font-medium text-center whitespace-nowrap">
                                {{ $key + 1 }}
                            </td>

                            <!-- نام مشتری -->
                            <td
                                class="px-4 py-2 vazir text-[14px] md:text-[16px] font-medium whitespace-nowrap overflow-hidden text-ellipsis">
                            ...
                            <!-- توضیحات -->
                            <td
                                class="px-4 py-2 vazir text-[14px] md:text-[16px] font-medium text-center whitespace-nowrap overflow-hidden text-ellipsis">
                                <div class="text-right whitespace-nowrap overflow-hidden text-ellipsis">
                                    <p class="text-sm">{{ $transaction->description }}</p>
                                </div>
                            </td>

                            <!-- تاریخ -->
                            <td class="px-4 py-2 vazir text-[14px] md:text-[16px] text-center whitespace-nowrap">
