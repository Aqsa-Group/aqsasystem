                        ...
                        <table class="w-full text-sm md:text-base text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="text-black border-b border-[#D9D9D9] bg-transparent hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-4 vazir text-[16px] font-medium">
                                        <div class="space-y-1">
                                            <p class="font-semibold">{{ $approval->recipient->fullname ?? $approval->giver_name }}</p>
                                    ...
                                    <td class="px-4 py-4 vazir text-[16px] font-medium">
                                        <code class="bg-gray-100 px-2 py-1 rounded">{{ $approval->tracking_code }}</code>
                                    </td>
                                    <td class="px-4 py-4 vazir text-[16px] font-medium">
                                        <div class="whitespace-nowrap">
                                            <div class="font-medium">{{ $approval->created_at->format('Y/m/d') }}</div>
                                            <div class="text-gray-500 text-sm">{{ $approval->created_at->format('H:i:s') }}</div>
                                        </div>
                                    </td>
