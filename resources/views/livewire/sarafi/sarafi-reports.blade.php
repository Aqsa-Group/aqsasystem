       ...
       <thead
                            ...
                            <tbody>
                               ...
                               transition-colors" dir="ltr">
                                        ...
                                        <td
                                            class="px-2 py-4 text-right {{ ($report['balances']['usd'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['usd'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500') }}">
                                            {{ number_format($report['balances']['usd'] ?? 0, 2) }}
                                        </td>
                                        <td
                                            class="px-2 py-4 text-right {{ ($report['balances']['afn'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['afn'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500') }}">
                                            {{ number_format($report['balances']['afn'] ?? 0, 2) }}
                                        </td>
                                        <td
                                            class="px-2 py-4 text-right {{ ($report['balances']['irr'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['irr'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500') }}">
                                            {{ number_format($report['balances']['irr'] ?? 0, 2) }}
                                        </td>
                                        <td
                                            class="px-2 py-4 text-right {{ ($report['balances']['pkr'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['pkr'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500') }}">
                                            {{ number_format($report['balances']['pkr'] ?? 0, 2) }}
                                        </td>
                                        <td
                                            class="px-2 py-4 text-right {{ ($report['balances']['eur'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['eur'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500') }}">
                                            {{ number_format($report['balances']['eur'] ?? 0, 2) }}
                                        </td>
                                        <td
                                            class="px-2 py-4 text-right {{ ($report['balances']['aed'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['aed'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500') }}">
                                            {{ number_format($report['balances']['aed'] ?? 0, 2) }}
                                        </td>
                                        <td
                                            class="px-2 py-4 text-right {{ ($report['balances']['try'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['try'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500') }}">
                                            {{ number_format($report['balances']['try'] ?? 0, 2) }}
                                        </td>
                                        <td
                                            class="px-2 py-4 text-right {{ ($report['balances']['cny'] ?? 0) < 0 ? 'text-red-600 font-bold' : (($report['balances']['cny'] ?? 0) > 0 ? 'text-green-600 font-bold' : 'text-gray-500') }}">
