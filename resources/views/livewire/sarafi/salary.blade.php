<div>
 ...
 <!-- Header Section -->
    ...
    <div class="w-full max-w-[1400px] mx-auto p-4">
        ...
        @if($paymentMethod === 'کارتی' && $selectedCustomer)
                ...
                <div
                    ...
                    <div class="flex gap-4 flex-wrap">
                        <button wire:click="setPaymentMethod('نقدی')" class="rounded-[8px] p-[10px] text-white vazir font-semibold transition-colors duration-500 ease-in-out
                            {{ $paymentMethod === 'نقدی' ?  'bg-[#184D6C]' : 'bg-[#FFFF] border border-[#184D6C] text-black' }}">
                            پرداخت نقدی
                        </button>
                        ...
                        <button wire:click="setPaymentMethod('کارتی')" class="rounded-[8px] p-[10px] text-white vazir font-semibold transition-colors duration-500 ease-in-out
                            {{ $paymentMethod === 'کارتی' ? 'bg-[#184D6C]' : 'bg-[#FFFF] border border-[#184D6C] text-black' }}">
                            پرداخت کارتی
                        </button>
                    </div>
                </div>
                ...
                <form wire:submit.prevent="paySalary">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold">
                                    {{ $staffDetails->name }} {{ $staffDetails->fathername }}
                                </span>
                            </div>
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold text-green-700 dark:text-green-400">
                                    {{ number_format($staffDetails->final_salary) }} افغانی
                                </span>
                            </div>
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold ltr">
                                    {{ explode(' ', $staffDetails->contract_start)[0] }}
                                </span>
                            </div>

                            @if($staffDetails->customer_id)
                            <div class="flex justify-between">
                                <span class="text-gray-600 dark:text-gray-300">مشتری ثبت شده:</span>
                                <span class="font-semibold text-blue-600 dark:text-blue-400">
                                    {{ $staffDetails->customer->fullname ?? 'ندارد' }}
                                </span>
                            </div>
                            @endif
                        ...
                        <div class="border-t pt-3 space-y-2">
                            ...
                            <div class="flex justify-between text-base">
                                ...
                                <span class="font-bold text-green-700 dark:text-green-400">
                                    {{ number_format($dueAmount) }} افغانی
                                </span>
                            </div>
                                ...
                                <table class="w-full text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            ...
                                            <td class="p-1 ltr">{{ $day['date'] }}</td>

                                            <td class="p-1">
                                                <span
                                                    class="{{ $day['morning_present'] ? 'text-green-600' : 'text-red-600' }}">
                                                    {{ $day['morning_present'] ? '✓' : '✗' }}
                                                </span>
                                            </td>
                                            ...
                                            <td class="p-1">
                                                <span
                                                    class="{{ $day['evening_present'] ? 'text-green-600' : 'text-red-600' }}">
                                                    {{ $day['evening_present'] ? '✓' : '✗' }}
                                                </span>
                                            </td>

                                            <td class="p-1">
                                                {{ $day['leave_type'] !== 'none' ? $day['leave_type'] : '-' }}
                                            </td>

                                            <td class="p-1 font-bold text-green-700 dark:text-green-400">
                                                {{ number_format($day['salary']) }}
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                    ...
                    <div class="mt-3 grid grid-cols-1 gap-3">
                        <div class="flex-1 w-full">
                            <div class="relative w-full">
                                <label class="block text-[16px] font-medium dark:text-white text-black mb-1 vazir">
                                    @if($staffDetails && $staffDetails->customer_id)
                                   کارت کارمند
                                    @else
                                    انتخاب کارت کارمند
                                    @endif
                                ...
                                <div
                                    ...
                                    <div>
                                        <span class="font-bold">{{ $selectedCustomer->fullname ??
                                            $staffDetails->customer->fullname ?? 'مشتری' }}</span>
                                        <span class="text-sm text-gray-600 dark:text-gray-300 mr-2">- {{
                                            $selectedCustomer->account_number ?? $staffDetails->customer->account_number
                                            ?? '' }}</span>
                                    </div>
                                </div>
                                @else
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="bg-blue-100 px-3 py-2 rounded-lg flex items-center gap-2">
                            <span class="text-blue-700 vazir">کارمند: {{ $staffDetails->name }} {{
                                $staffDetails->fathername }}</span>
                        </div>
                        @endif
                    </div>
                </div>
    ...
    <tr class="text-black border-b  dark:text-white border-[#D9D9D9]
                               ...
                               transition-colors">                                    <td class="px-2 py-4 vazir text-[14px] md:text-[16px] font-medium text-center w-16">
                                    ...
                                    <td class="px-4 py-4 vazir text-[14px] md:text-[16px] font-medium w-32">
                                        {{ collect($currencies)->firstWhere('code', $salary->currency)['name_fa'] ??
                                        $salary->currency }}
                                    </td>
