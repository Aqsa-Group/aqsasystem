                                ...
                                <tbody class="divide-y divide-gray-100">
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap font-medium text-gray-900">
                                            {{ $report->staff->fullname ?? 'بدون نام' }}
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="font-bold text-gray-900">{{
                                                number_format($report->total_quantity) }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-green-600 font-bold">{{
                                                number_format($report->purchase_price_per_unit) }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-red-600 font-bold">{{ number_format($report->retail_price)
                                                }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-orange-600 font-bold">{{
                                                number_format($report->wholesale_price) }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium 
                                                {{ $report->status === 'موجود' ? 'bg-green-100 text-green-800' : 
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium 
                                                {{ $report->sale_type === 'retail' ? 'bg-teal-100 text-teal-800' : 'bg-indigo-100 text-indigo-800' }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-green-600 font-bold">{{
                                                number_format($report->received_amount) }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-red-600 font-bold">{{
                                                number_format($report->remaining_amount) }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-orange-600 font-bold">{{ number_format($report->discount)
                                                }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-green-600 font-bold">{{
                                                number_format($report->final_profit) }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium 
                                                {{ $report->is_return ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800' }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="font-bold text-gray-900">{{ number_format($report->quantity)
                                                }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-gray-900 font-bold">{{
                                                number_format($report->price_per_unit) }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="font-bold text-gray-900">{{ number_format($report->total_price)
                                                }}</span>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-green-600 font-bold">{{ number_format($report->profit)
                                                }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-red-600 font-bold">{{ number_format($report->loss)
                                                }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            {{ $report->created_at ?
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium 
                                                {{ $report->type === 'ورود' ? 'bg-green-100 text-green-800' : 
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="font-bold {{ $report->quantity_change > 0 ? 'text-green-600' : 'text-red-600' }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="font-bold text-gray-900">{{
                                                number_format($report->new_quantity) }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-gray-900">{{ number_format($report->unit_price ?? 0)
                                                }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="font-bold text-gray-900">{{ number_format($report->total_amount
                                                ?? 0) }}</span>
                                        </td>
