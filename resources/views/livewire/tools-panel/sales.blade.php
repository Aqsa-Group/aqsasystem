    ...
    <div class="flex flex-col lg:flex-row gap-6 p-4">
        ...
        <div class="flex flex-col bg-white w-full lg:w-1/2 p-6 rounded-xl shadow-lg border border-gray-200">
            ...
            <div class="mb-6">
                ...
                <!-- نمایش لیست محصولات -->
                @if($searchProduct && count($filteredProducts) > 0 && !$selectedProduct)
                <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <div class="text-xs text-gray-500 mt-2 flex items-center">
                        ...
                        حداکثر: {{ number_format($selectedProduct->total_quantity) }} {{ $selectedProduct->unit }}
                    </div>
                    @endif
                </div>
                <div>
                ...
                <div class="space-y-3 max-h-60 overflow-y-auto mb-6">
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            ...
                            <div class="text-xs text-gray-500 mt-1">
                                <i class="fa-solid fa-tag ml-1"></i>
                                {{ number_format($item['quantity']) }} × {{ number_format($item['unit_price']) }} افغانی
                            </div>
                        </div>
                ...
                <div class="bg-blue-50 p-4 rounded-lg mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <span>{{
                                \Morilog\Jalali\Jalalian::fromDateTime($selectedSaleForReturn->created_at)->format('Y/m/d
                                H:i') }}</span>
                        </div>
                        <div>
                            <span class="font-medium">مبلغ کل:</span>
                            <span>{{ number_format($selectedSaleForReturn->total_price) }} افغانی</span>
                        </div>
                    </div>
                </div>
