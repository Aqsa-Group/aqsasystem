                ...
                <div>
                    ...
                    <div x-data="{
                        ...
                        <datalist id="staffsList">
                            ...
                            <option value="{{ $staff->name }} {{ $staff->lastname }} - {{ $staff->job }}">
                                {{ $staff->name }} {{ $staff->lastname }} ({{ $staff->job }}) - {{
                                number_format($staff->salary) }} افغانی
                            </option>
                            @endforeach
                        </datalist>
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="bg-blue-100 px-3 py-2 rounded-lg flex items-center gap-2">
                        <span class="text-blue-700 vazir">فیلتر: {{ $selectedStaff->name ?? '' }} {{
                            $selectedStaff->lastname ?? '' }}</span>
                    ...
                    <div class="relative w-full md:w-[302px]">
                        ...
                        @if($search && count($filteredStaffs) > 0 && !$selectedStaffId)
                        <ul
                            ...
                            <li wire:click="selectStaff({{ $staff->id }})"
                                class="px-3 py-2 hover:bg-blue-100 cursor-pointer flex justify-between items-center">
                                <span>{{ $staff->name }} {{ $staff->lastname }}</span>
                                <span class="text-gray-500 text-sm">{{ $staff->job }}</span>
                            </li>
                            @endforeach
                        </ul>
                        @endif
                        ...
                        <tbody>
                            ...
                            <tr class="ttransactionext-black border-b border-[#D9D9D9] bg-transparent">
                                ...
                                <td class="px-4 py-4 vazir text-[14px] md:text-[16px] font-medium w-48">
                                    {{ $salary->staff->name ?? '-' }} {{ $salary->staff->lastname ?? '' }}
                                </td>
                                ...
                                <td class="px-4 py-4 vazir text-[14px] md:text-[16px] font-medium text-center w-80">
                                    <div class="space-y-1 text-right">
                                        <p class="text-sm">تفصیلات: {{ $salary->description ?? 'بدون توضیح' }}</p>
                                    </div>
                                </td>
