    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-4 pb-0 pt-1">
        ...
        <div
            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center">
                    ...
                    <span class="font-bold">{{ number_format($loanCards['total_loan']['afn']) }}</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="font-medium">دالر:</span>
                    <span class="font-bold">{{ number_format($loanCards['total_loan']['usd']) }}</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="font-medium">تومان:</span>
                    <span class="font-bold">{{ number_format($loanCards['total_loan']['irr']) }}</span>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center">
                    <span class="font-medium">افغانی:</span>
                    <span class="font-bold">{{ number_format($loanCards['total_paid']['afn']) }}</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="font-medium">دالر:</span>
                    <span class="font-bold">{{ number_format($loanCards['total_paid']['usd']) }}</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="font-medium">تومان:</span>
                    <span class="font-bold">{{ number_format($loanCards['total_paid']['irr']) }}</span>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center">
                    <span class="font-medium">افغانی:</span>
                    <span class="font-bold">{{ number_format($loanCards['remaining_loan']['afn']) }}</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="font-medium">دالر:</span>
                    <span class="font-bold">{{ number_format($loanCards['remaining_loan']['usd']) }}</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="font-medium">تومان:</span>
                    <span class="font-bold">{{ number_format($loanCards['remaining_loan']['irr']) }}</span>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center">
                    <span class="font-medium">افغانی:</span>
                    <span class="font-bold">{{ $loanCards['percentage']['afn'] }}%</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="font-medium">دالر:</span>
                    <span class="font-bold">{{ $loanCards['percentage']['usd'] }}%</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="font-medium">تومان:</span>
                    <span class="font-bold">{{ $loanCards['percentage']['irr'] }}%</span>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col bg-[#F5F5F5] w-full lg:w-[494px] p-[12px] h-auto rounded-[12px] space-y-2"
            ...
            <div class="flex flex-row justify-between p-[10px] border border-[#8C8C8C] rounded-[12px] flex-wrap mb-5">
                <p class="flex justify-center items-center text-center">
                    ...
                    {{ $transactionId ? 'فورم ویرایش قرضه' : 'فورم ثبت قرضه' }}
                </p>
                ...
                <div class="flex gap-4 flex-wrap">
                    ...
                    <button wire:click="toggleTransactionType"
                        class="rounded-[8px] p-[10px] text-white vazir font-semibold
                                    ...
                                    {{ $transactionType === 'برد' ? 'bg-gradient-to-br from-indigo-400 to-indigo-500' : 'bg-[#DD2424]' }}">
