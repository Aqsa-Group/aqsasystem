        ...
        <div
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-lg font-bold">{{ number_format($withdrawalStats['today']['toman']) }}</span>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-lg font-bold">{{ number_format($withdrawalStats['week']['toman']) }}</span>
                </div>
        ...
        <div
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-lg font-bold">{{ number_format($withdrawalStats['month']['toman']) }}</span>
                </div>
        ...
        <div
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-lg font-bold">{{ number_format($withdrawalStats['total']['toman']) }}</span>
                </div>
