<div>
    ...
    <div class="flex flex-col md:flex-row items-center gap-3 md:gap-4 mb-4  md:mb-6 mr-4 md:mr-10">
        ...
        <button wire:click="createCustomer"
            ...
            <img src="{{ asset('assets/sarafi/all_icon/user-add.svg') }}" alt="Add" class="w-[24px] h-[24px] md:w-[30px] md:h-[30px] me-2">
            ...
            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                    ...
                    <td class="px-3 md:px-6 py-3 md:py-4 text-right flex items-center gap-2 md:gap-3">
                        ...
                        <span class="text-[14px] md:text-lg text-gray-900 dark:text-white">{{ $customer->fullname }}</span>
                    </td>

                    <!-- شماره حساب -->
                    <td class="px-3 md:px-6 py-3 md:py-4 text-[14px] md:text-[16px] text-black vazir">{{ $customer->account_number ?? '-' }}</td>

                    <!-- شهر -->
                    <td class="px-3 md:px-6 py-3 md:py-4 text-[14px] md:text-[16px] text-black vazir">{{ $customer->city ?? '-' }}</td>

                    <!-- تلفن -->
                    <td class="px-3 md:px-6 py-3 md:py-4 text-[14px] md:text-[16px] text-black vazir">{{ $customer->phone ?? '-' }}</td>

                    <!-- تذکره -->
                    <td class="px-3 md:px-6 py-3 md:py-4 text-[14px] md:text-[16px] text-black vazir">{{ $customer->idcard_number ?? '-' }}</td>
