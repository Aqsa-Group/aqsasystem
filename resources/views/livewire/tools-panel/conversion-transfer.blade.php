    ...
    <div class="container mx-auto px-4">
        ...
        <div class="flex flex-col lg:flex-row gap-5 mt-4">
            ...
            <div class="flex flex-col bg-[#F5F5F5] w-full lg:w-[574px] p-[12px] h-fit rounded-[12px] space-y-2"
                ...
                {{ $transactionType === 'خرید' ? 'bg-gradient-to-br from-black to-blue-500  text-pink-800 p-6 rounded-xl shadow-lg transition-all duration-300' : 'bg-gradient-to-br from-black to-red-500  text-pink-800 p-6 rounded-xl shadow-lg transition-all duration-300' }}">
