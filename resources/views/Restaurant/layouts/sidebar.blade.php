<!DOCTYPE html>
<html class="dark" lang="{{ session('locale', config('app.locale')) }}"
    dir="{{ session('locale') === 'en' ? 'ltr' : 'rtl' }}">
...
<head>
    ...
    @include('Restaurant.layouts.links')
    <script>
        tailwind.config = {
            darkMode: 'class',
            theme: {
...
<body class="vazir dark:bg-background-dark dark:text-white">
    ...
    <div id="loader">
        <div class="loader-content">
            ...
            <div class="text-xl font-bold mb-2">{{ Auth::guard('restaurant')->user()->restaurant_name }}</div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="brand-section">
                            ...
                            <div class="brand-text yekan text-[30px]">
                                {{ Auth::guard('restaurant')->user()->restaurant_name }}
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="profile-section">
                            ...
                            <div class="profile-menu" id="profileMenu">
                                ...
                                <div class="profile-logout">
                                    <form action="{{ route('restaurnat.logout') }}" method="POST">
                                        @csrf
   ...
   class="menu-link {{ request()->routeIs('restaurant.home') ? 'active' : '' }}">
   ...
   class="menu-link {{ request()->routeIs('restaurant.menu') ? 'active' : '' }}">
                                    <svg class="menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
