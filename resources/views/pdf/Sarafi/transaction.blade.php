...
<head>
    <meta charset="UTF-8">
    <title>سند برداشت - صرافی {{ Auth::guard('sarafi')->user()->sarafi_name}}</title>
    <style>
    ...
    <div class="document">
        ...
        <div class="header">
            <table class="header-table" style="width:100%; border-collapse: collapse;">
                <tr>
                    <td style="text-align:right;">نوع ترانزکشن : {{ $transaction->type }}</td>
        ...
        <table class="info-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    {{ $currenciesFa[strtolower($transaction->currency)] ?? '-' }}
                </td>
            </tr>
            <tr>
                <td>توسط:</td>
