...
<head>
    <meta charset="UTF-8">
    <title>Customer Card - {{ $customer->fullname }}</title>
    <style>
        @font-face {
        ...
        <table class="card-header-table">
            <tr>
                <td width="50%">
                    ...
                    <div class="platinum-badge">{{ $cardType }} Card</div>
                </td>
                <td style="width: 18mm; height: 18mm;">
                    <img src="{{ public_path('storage/' . $customer->image) }}" alt="امضاء"
            ...
            <tr>
                <td style="vertical-align: middle; text-align: center;">
                    <div class="card-number">
                        @php $groups = str_split($accountNumber, 4); @endphp
                        @foreach ($groups as $group)
                            <span class="number-group">{{ $group }}</span>
                        @endforeach
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: middle; text-align: left; width: 70%;">
                    <div class="card-info">
                        ...
                        <div class="value">{{ strtoupper($customer->fullname) }}</div>

                        <div class="label" style="margin-top: 4px;">VALID THRU</div>
                        <div class="value">{{ \Carbon\Carbon::now()->addYears(3)->format('m/y') }}</div>
                    </div>
                </td>
                ...
                <td style="vertical-align: middle; text-align: right; width: 30%;">
                    <div class="qr-section">
                        <div class="qr-code">
                            @if (isset($qrCodeUrl))
                                <img src="{{ $qrCodeUrl }}" alt="QR Code" title="اسکن کنید برای اطلاعات مشتری">
                            @else
