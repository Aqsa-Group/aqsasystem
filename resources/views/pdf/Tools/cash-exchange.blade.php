...
<head>
    <meta charset="UTF-8">
    <title>تبدیل ارز صرافی - {{ Auth::guard('tools')->user()->company_name ?? 'صرافی' }}</title>
    <style>
...
<body>
    <div class="document">
        <h1 style="text-align:center; font-family: amiri ,sans-serif" class="shabnam-fd">صرافی {{ Auth::guard('tools')->user()->company_name }}</h1>
        ...
        <div class="contact-info">
            <table style="width:100%; border-collapse: collapse;">
                <tr>
                    <td>
                        <strong>تماس:</strong> +93{{ Auth::guard('tools')->user()->phone }}
                    </td>
                </tr>

                <tr>
                    <td>
                        <strong>آدرس:</strong> افغانستان {{ Auth::guard('tools')->user()->address }}
                    </td>
                </tr>
            </table>
        </div>
