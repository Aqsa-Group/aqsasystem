...
<tbody class="divide-y divide-gray-100 dark:divide-gray-700">
    @forelse($loans as $index => $loan)
        ...
        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
            ...
            <td class="p-2 border text-blue-600 font-bold">{{ number_format($qarzaColumn) }}</td>
            <td class="p-2 border text-green-600 font-bold">{{ number_format($loan['loan_recipt'] ?? 0) }}</td>
            <td class="p-2 border text-red-600 font-bold">{{ number_format($runningBalance) }}</td>
            <td class="p-2 border">
