...
<head>
    ...
    <style>
        @font-face {
            font-family: 'Vazir';
            src: url('{{ asset('fonts/Scheherazade-Regular.ttf') }}') format('truetype');
            font-weight: 300;
            font-style: normal;
        }
        ...
        @font-face {
            ...
            src: url('{{ asset('fonts/shabnam/Shabnam-Bold.ttf') }}') format('truetype');
            font-weight: 300;
            font-style: normal;
        }
...
<body class="min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-5xl h-full flex flex-col md:flex-row  overflow-hidden shadow-2xl ">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-6">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="username"
                        ...
                        <img src="{{ asset('assets/user.png') }}" class="absolute right-3 bottom-1 transform -translate-y-1/2 h-5 w-5">
                    </div>
                ...
                <div class="relative mt-4">
                  ...
                  <img src="{{ asset('assets/password.png') }}" class="absolute right-3 bottom-1 transform -translate-y-1/2 h-5 w-5">
                </div>
        ...
        <div
            ...
            <img src="{{ asset('assets/money.jpg') }}" class="absolute w-full h-full object-cover" alt="">
