...
<body>
    <div class="container" id="container">
        ...
        <div class="form-container sign-in">
            <form action="{{ route('sarafi.login') }}" method="POST">
                @csrf
                <h1 class="text-center mb-4">ورود به پنل صرافی</h1>
                <input type="text" name="username" placeholder="نام کاربری" value="{{ old('username') }}" required>
        ...
        <div class="toggle-panel toggle-right">
            <div class="image-wrapper">
                <img src="{{ asset('assets/login.jpg') }}" alt="">
