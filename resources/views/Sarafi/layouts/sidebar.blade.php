    ...
    <div class="flex items-center space-x-4 rtl:space-x-reverse">
        ...
        <div class="relative inline-block w-[145px] h-[56px] p-4 vazir">
            <button id="dropdownButton"
                ...
                <img src="{{ asset('assets/sarafi/all_icon/Flags.png') }}" class="w-5 h-5 ml-2" alt="Dari">
                فارسی
            </button>
            <ul id="dropdownMenu"
                ...
                <li class="flex items-center px-3 py-2 hover:bg-gray-100 cursor-pointer">
                    <img src="{{ asset('assets/sarafi/all_icon/Flags.png') }}" class="w-5 h-5 ml-2" alt="Pashto">
                    پشتو
                </li>
                <li class="flex items-center px-3 py-2 hover:bg-gray-100 cursor-pointer">
                    <img src="{{ asset('assets/sarafi/all_icon/united.png') }}" class="w-5 h-5 ml-2" alt="English">
                    English
                </li>
            </ul>
        </div>
