    ...
    @if ($currentUser && $currentUser->username==='test')
            ...
            : 'text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
                        ...
                        <div x-show="openItems.finance" x-transition class="mr-6 mt-2 space-y-1">
                            ...
                            <!-- Staff Register -->
                            <a href="{{ route('sarafi.staff') }}" @click="setActive('finance-staff','finance')" :class="active === 'finance-staff'
                ? 'bg-[#122EE1] text-white'
                : 'text-gray-600 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
                            ...
                            <!-- Withdraw -->
                            <a href="{{ route('sarafi.withdraw') }}" @click="setActive('finance-withdraw','finance')"
                ...
                : 'text-gray-600 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
                            ...
                            <!-- Salary -->
                            <a href="{{ route('sarafi.salary') }}" @click="setActive('finance-salary','finance')"
