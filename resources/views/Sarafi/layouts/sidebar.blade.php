                            ...
                            <div id="profileDropdownDesktop"
                                ...
                                <div class="p-3 border-b space-y-5">
                                    <div class="flex flex-col justify-center items-center">
                                        ...
                                        @else
                                        <img src="{{ asset('assets/sarafi/avatar.svg') }}"
                                            alt="{{ $currentUser->name }}" class="h-20 w-20 rounded-full">
                                        @endif
                                ...
                                <div class="space-y-2">
                                    <a href="{{ route('sarafi.users') }}"
                                        ...
                                        <img src="{{ asset('assets/sarafi/all_icon/account_profile.svg') }}"
                                    ...
                                    <a href="{{ route('sarafi.users') . '#edit=' . $currentUser->id }}"
                                        class="flex items-center px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition vazir">
                                        <img src="{{ asset('assets/sarafi/all_icon/edit.svg') }}" alt="ویرایش"
                                            class="ml-2">
                                ...
                                <form action="{{ route('sarafi.logout') }}" method="POST" class="pt-2 border-t">
                                    ...
                                    <button type="submit"
                                        ...
                                        <img src="{{ asset('assets/sarafi/all_icon/logout.svg') }}" alt="خروج"
                                            class="ml-2">
