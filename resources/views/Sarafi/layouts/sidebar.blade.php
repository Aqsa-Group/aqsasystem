    ...
    <div id="mainContent">
        <header
            ...
            <div class="flex items-center space-x-4 rtl:space-x-reverse gap-6 justify-center ">
                <div class="text-[40px] text-[#122EE1] font-bold yekan">{{ Auth::guard('sarafi')->user()->sarafi_name }}</div>
                ...
                <div class="relative">
                    ...
                    <div id="profileDropdown"   style="box-shadow: 0px 4px 4px 0px #00000040, 0 0 0 0 #3B82F6;"
                        ...
                        <div class="flex justify-start items-center  ">
                            ...
                            <a href="{{ route('sarafi.users') }}" class="block px-4 py-2 text-gray-700 vazir">تنظیمات</a>
                        </div>
