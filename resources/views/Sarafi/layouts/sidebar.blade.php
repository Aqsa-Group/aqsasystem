...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/sarafi/main.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/sarafi/chat.css') }}">
...
<body class="vazir dark:text-white overflow-x-hidden" >
    ...
    <script src="{{ asset('assets/js/sarafi/main.js') }}"></script>
