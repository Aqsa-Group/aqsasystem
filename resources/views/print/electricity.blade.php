                    ...
                    <table class="form-table" role="table" aria-label="مشخصات">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                    {{ $accounting->market->name ?? '---' }}
                                </td>

                                <td style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                    {{ $accounting->shop->number ?? $accounting->booth->number ?? '---' }}
                                </td>
                                ...
                                <table class="amount-rows" role="table" aria-label="مقادیر" style="width:100%;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align:right ;">{{ $accounting->current_degree ??
                                                $accounting->current_reading ?? '---' }}</td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:center;">درجه قبلی</td>
                                            <td style="text-align:right ;">{{ $accounting->past_degree ??
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:right ;">{{ number_format($accounting->degree_price ??
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:right ;">{{ number_format($accounting->remained ??
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:right ;">{{ number_format($total) }} افغانی</td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:center;">مبلغ پرداخت شده</td>
                                            <td style="text-align:right ;">{{ number_format($accounting->paid ??
