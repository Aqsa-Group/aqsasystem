...
<div class="no-page-break">
    <h3 style="font-size:12px; margin-bottom:4px;">خلاصه برداشت‌ها و حقوق‌ها به تفکیک کارمند</h3>
    <table>
        <thead>
            <tr>
                <th rowspan="2">#</th>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="{{ 2 + (count($currencies) * 2) }}" style="text-align:center; padding:10px;">داده‌ای یافت نشد</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
...
<div class="no-page-break">
    <table class="summary-table">
        <thead><tr><th colspan="2">جمع کل برداشت‌ها</th></tr></thead>
        <tbody>
            <tr>
...
<div class="no-page-break">
    <table class="summary-table">
        <thead><tr><th colspan="2">جمع کل حقوق‌ها</th></tr></thead>
        <tbody>
            <tr>
                <td style="width:20%; font-weight:bold;">کل حقوق‌ها</td>
                @foreach($currencies as $code => $name)
...
<div class="page-break">
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="7" style="text-align:center; padding:10px;">هیچ تراکنشی یافت نشد</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
