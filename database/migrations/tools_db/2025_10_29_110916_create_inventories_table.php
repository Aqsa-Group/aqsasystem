...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('inventories', function (Blueprint $table) {
            ...
            // اضافه کردن فیلدهای مدیریت کاربر - این خطوط اضافه شدند
            ...
            // تعریف foreign keys - این بخش اصلاح شد
            $table->foreign('user_id')->references('id')->on('users')->onDelete('SET NULL');
            $table->foreign('admin_id')->references('id')->on('users')->onDelete('SET NULL');
        });
        
        // ایجاد جدول برای تاریخچه تغییرات موجودی
        Schema::create('inventory_histories', function (Blueprint $table) {
            $table->id();
            $table->foreignId('inventory_id')->constrained('inventories')->onDelete('cascade');
            $table->enum('type', ['ورود', 'خروج', 'تعدیل', 'فروش', 'خرید'])->comment('نوع تراکنش');
            ...
            // اضافه کردن فیلدهای مدیریت کاربر برای تاریخچه - این خطوط اضافه شدند
            $table->foreignId('user_id')->nullable()->comment('کاربر ایجاد کننده');
            $table->foreignId('admin_id')->nullable()->comment('ادمین مربوطه');
